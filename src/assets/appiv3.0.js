window.TILE_VERSION = {
  "ditu": {
    "normal": {"version": "088", "updateDate": "20200716"},
    "satellite": {"version": "009", "updateDate": "20200716"},
    "normalTraffic": {"version": "081", "updateDate": "20200716"},
    "satelliteTraffic": {"version": "083", "updateDate": "20200716"},
    "mapJS": {"version": "104", "updateDate": "20200716"},
    "satelliteStreet": {"version": "083", "updateDate": "20200716"},
    "earthVector": {"version": "001", "updateDate": "20200716"}
  },
  "webapp": {
    "high_normal": {"version": "001", "updateDate": "20200716"},
    "lower_normal": {"version": "002", "updateDate": "20200716"}
  },
  "api_for_mobile": {
    "vector": {"version": "002", "updateDate": "20200716"},
    "vectorIcon": {"version": "002", "updateDate": "20200716"}
  }
};
window.BMAP_AUTHENTIC_KEY = "kTHIMKfxtNOzCzFvErGtbd0i2v1o3no9";
(function () {
  function aa(a) {
    throw a;
  }
  ...
  A.U.b0 = function (a) {
    A.U.Gs(a, "expand") ? A.U.qc(a, "expand") : A.U.hb(a, "expand")
  };
  A.U.Gs = function (a) {
  ...
  A.U.vg = function (a, b) {
    var c = A.U, a = c.ea(a);
    if (a === q) return a;
    var b = A.Rk.hO(b), e = a.style[b];
    if (!e) var f = c.iB[b], e = a.currentStyle || (A.fa.na ? a.style : getComputedStyle(a, q)),
  ...
  A.U.la = function (a) {
    a = A.U.ea(a);
    if (a === q) return a;
    var b = A.U.jD(a), c = A.fa, e = A.U.vg;
  ...
  /(\d+\.\d)?(?:\.\d)?\s+safari\/?(\d+\.\d+)?/i.test(ka) && !/chrome/i.test(ka) && (A.fa.$x = +(RegExp.$1 || RegExp.$2));
  /chrome\/(\d+\.\d)/i.test(navigator.userAgent) && (A.fa.lw = +RegExp.$1);
  A.jc = A.jc || {};
  ...
  A.lang.Ha.prototype.dispatchEvent = function (a, b) {
    A.lang.wg(a) && (a = new A.lang.ju(a));
    !this.Ci && (this.Ci = {});
    var b = b || {}, c;
    for (c in b) a[c] = b[c];
    var e = this.Ci, f = a.type;
    a.target = a.target || this;
    a.currentTarget = this;
    f.indexOf("on") != 0 && (f = "on" + f);
    A.lang.Qs(this[f]) && this[f].apply(this, arguments);
  ...
  /android (\d+(\.\d)?)/i.test(navigator.userAgent) && (A.platform.DB = A.DB = RegExp.$1);
  ...
  A.BK = function () {
    function a(a) {
      document.addEventListener && (this.element = a, this.EK = this.Ak ? "touchstart" : "mousedown", this.RC = this.Ak ? "touchmove" : "mousemove", this.QC = this.Ak ? "touchend" : "mouseup", this.oh = t, this.Qt = this.Pt = 0, this.element.addEventListener(this.EK, this, t), ia.V(this.element, "mousedown", u()), this.handleEvent(q))
    }

    a.prototype = {
      Ak: "ontouchstart" in window || "createTouch" in document, start: function (a) {
        ma(a);
        this.oh = t;
        this.Pt = this.Ak ? a.touches[0].clientX : a.clientX;
        this.Qt = this.Ak ? a.touches[0].clientY : a.clientY;
        ...
        if (10 < Math.abs((this.Ak ? a.touches[0].clientX : a.clientX) - this.Pt) || 10 < Math.abs(c - this.Qt)) this.oh = p
      }, end: function (a) {
        na(a);
  ...
  var qa = window.BMap_loadScriptTime, ra = (new Date).getTime(), ua = q, va = p, wa = 5042, xa = 5002, ya = 5003,
    za = "load_mapclick", Ba = 5038, Ca = 5041, Da = 5047, Ea = 5036, Fa = 5039, Ha = 5037, Ia = 5040, Ja = 5011,
    Ka = 7E3;
  var La = 0;
  ...
  function Ma(a, b) {
    if (a = A.ea(a)) {
      ...
      c.Cu();
      c.aa = {Jc: t, kc: 0, Ws: 0, bM: 0, s4: 0, IB: t, GE: -1, re: []};
      ...
      c.M.HC && (setTimeout(function () {
        Ra(za)
      }, 1E3), Ta.load("mapclick", function () {
        window.MPC_Mgr = window.MPC_Mgr || {};
        window.MPC_Mgr[c.da] = new Ua(c)
      }, p));
  ...
  A.extend(Ma.prototype, {
    za: function () {
      ...
      a.M.hs && (a.aa.Tl = setInterval(a.co, 80))
    }, fk: function (a, b, c, e) {
      var f = this.wa().Xb(this.ja()), g = this.Bc, i = p;
      ...
      if (Za(a) && (this.Cu(), this.dispatchEvent(new P("onzoomstart")), a = this.Dn(a).zoom, a !== this.Xa)) {
        this.xc = this.Xa;
        this.Xa = a;
        var c;
        b ? c = b : this.ih() && (c = this.ih().la());
        c && (c = this.Pn(Ya(c, this.M.Ia), this.xc), this.fk(this.width / 2 - c.x, this.height / 2 - c.y, this.kg(c, this.xc), p));
      ...
      if (a instanceof Q || a instanceof J) a = Ya(a, this.M.Ia), this.Tb = this.Bc.ii(a, this.Lb), this.ae = Q.VD(a) ? new J(a.lng, a.lat) : this.Bc.nh(this.Tb, this.Lb)
    }, Cg: function (a, b) {
      a = Math.round(a) || 0;
      b = Math.round(b) || 0;
      this.fk(-a, -b)
      ...
      if (this.Sa !== a) {
        ...
        this.Sa = this.M.Sa = a;
        this.Bc = this.Sa.jj();
        this.fk(0, 0, this.Nu(), p);
        this.Cu();
        var c = this.Dn(this.ja()).zoom;
        this.Ig(c);
      ...
      a === ab || a === Sa ? (this.ey(p), this.EN(t), this.M.sg = t, this.M.ok = t) : (this.ey(t), this.EN(p), this.M.sg = p, this.M.ok = p)
    }, tf: function (a) {
      var b = this;
      if (a instanceof Q || a instanceof J) b.qi(a, {noAnimation: p}); else if (bb(a)) if (b.Sa === Qa) {
        var c = H.MB[a];
        c && (pt = c.o, b.tf(pt))
      } else {
        var e = this.tH();
        e.Et(function (c) {
          0 === e.mm() && 2 === e.Ma.result.type && (c = c.xk(0).point, c = new J(c.lng, c.lat), c = cb(c, b.M.Ia), b.tf(c), Qa.sk(a) && b.UE(a))
        });
        e.search(a, {log: "center"})
      }
    }, od: function (a, b) {
      "[object Undefined]" !== Object.prototype.toString.call(b) && (b = parseInt(b));
      D.$p("cus.fire", "time", {z_loadscripttime: ra - qa});
      var c = this;
      if (bb(a)) if (c.Sa === Qa) {
        var e = H.MB[a];
        e && (pt = e.o, c.od(pt, b))
        ...
        f.Et(function (e) {
          if (0 === f.mm() && (2 === f.Ma.result.type || 11 === f.Ma.result.type)) {
            var g = e.xk(0).point, e = b || db.Mw(f.Ma.content.level, c), g = new J(g.lng, g.lat);
            c.od(g, e);
            Qa.sk(a) && c.UE(a)
          }
        });
        ...
        c.xc !== c.Xa && (e = new P("onzoomend"), e.xz = "centerAndZoom", c.dispatchEvent(e));
        c.M.Co && c.Co()
      }
    }, tH: function () {
      ...
      this.M.hs = p;
      this.co();
      this.aa.Tl || (this.aa.Tl = setInterval(this.co, 80))
    }, disableAutoResize: function () {
      this.M.hs = t;
      this.aa.Tl && (clearInterval(this.aa.Tl), this.aa.Tl = q)
    }, enableBizAuthLogo: function () {
      this.M.BC = p;
      this.po && this.po.show()
    }, disableBizAuthLogo: function () {
      this.M.BC = t;
      this.po && this.po.$()
    }, Co: function () {
      this.M.Co = p;
      this.mn || (this.mn = new BuildingLayer({S2: p}), this.Ne(this.mn))
    }, SV: function () {
      this.M.Co = t;
      this.mn && (this.Yf(this.mn), this.mn = q, delete this.mn)
    }, xb: function () {
      return this.Vr && this.Vr instanceof N ? new N(this.Vr.width, this.Vr.height) : new N(this.ab.clientWidth, this.ab.clientHeight)
    }, Be: function (a) {
      a && a instanceof N ? (this.Vr = a, this.ab.style.width = a.width + "px", this.ab.style.height = a.height + "px") : this.Vr = q
    }, Nb: function () {
      return cb(this.ae, this.M.Ia)
    }, Nu: x("ae"), ja: x("Xa"), fV: function () {
      this.co()
    }, Dn: function (a) {
      var b = this.M.fc, c = this.M.mc, e = t, a = Math.round(a);
      a < b && (e = p, a = b);
      a > c && (e = p, a = c);
      return {zoom: a, SC: e}
    }, Ra: x("ab"), yc: function (a, b) {
      a = Ya(a, this.M.Ia);
      b = b || this.ja();
      ...
      if (a) {
        var a = Ya(a, this.M.Ia), c = this.Pn(new J(a.lng, a.lat), b);
        c.x -= this.offsetX;
        c.y -= this.offsetY;
        return c
      }
      ...
      if (!this.tx()) return new hb;
      var b = a || {}, a = b.margins || [0, 0, 0, 0], c = b.zoom || q, b = this.Zb({x: a[3], y: this.height - a[2]}, c),
        a = this.Zb({x: this.width - a[1], y: a[0]}, c);
      return new hb(b, a)
    }, tx: function () {
      return !!this.loaded
    }, vR: function (a, b) {
      ...
      var c = {center: this.Nb(), zoom: this.ja()};
      ...
      return {center: cb(new J(c.lng, c.lat), this.M.Ia), zoom: f}
    }, vh: function (a, b) {
      var c;
      ...
      if (a && b) {
        if (a.Sb(b)) return 0;
        var c = this.M ? this.M.Ia : 5, a = Ya(a, c), b = Ya(b, c), c = 0, c = T.uk(a, b);
        if (c === q || c === l) c = 0;
        return c
      }
    }, Yw: function () {
      var a = [], b = this.Ba, c = this.De;
      ...
      for (var a = this.aa.GE; a < D.gr.length; a++) D.gr[a](this);
      this.aa.GE = a
    }, UE: function (a) {
      this.Lb = Qa.sk(a);
      this.mw = Qa.TK(this.Lb);
      ...
      a.tag = b;
      a instanceof kb && (this.Gh[b][a.da] = a, a.ya(this));
      var c = this;
      ...
      b || (b = "custom");
      this.Gh[b][a.da] && delete this.Gh[b][a.da]
    }, ow: function (a) {
      a || (a = "custom");
      this.Gh[a] = {}
    }, Cu: function () {
      var a = this.Sa.mf(), b = this.Sa.Te(), c = this.M;
      c.fc = c.AO || a;
      c.mc = c.zO || b;
      c.fc < a && (c.fc = a);
      c.mc > b && (c.mc = b)
      ...
      window[f + "_cbk_si_phpui" + g] = function (a) {
        var b = [];
        a.result && (0 === a.result.error && a.content && 0 === a.content.status) && (b = e.Ox(a.content.data.json));
        c && c(b)
      };
      window[f + "_cbk_si_api" + g] = function (a) {
        var b = [];
        0 === a.status && (b = a.info ? e.Ox(a.info.json) : e.Ox(a.data.json));
        c && c(b)
      };
      ...
      var g = D.nd + "custom/v2/mapstyle", i = "ak=" + pa + "&", i = i + "is_all=true&is_new=1&";
      ...
      var c = new P("oncopyrightoffsetchange", {kE: a, AV: b});
      this.M.bK = b;
      ...
      b.M.HC = t;
      D.$p("cus.fire", "count", "z_setmapstylecount");
      if (a) {
        b = this;
        a.styleJson && (a.styleStr = b.M_(a.styleJson));
        I() && A.fa.$x ? setTimeout(function () {
          b.M.xe = a;
        ...
        Ra(5050, c);
        a.style && (c = b.M.TB[a.style] ? b.M.TB[a.style].backColor : b.M.TB.normal.backColor) && (this.Ra().style.backgroundColor = c)
      }
    }, jY: function (a) {
      ...
      a ? this.Tr && this.Tr.Bf === a || (this.Yf(this.Tr), this.Tr = new qb({geotableId: a}), this.Ne(this.Tr)) : this.Yf(this.Tr)
    }, Od: function () {
      var a = this.ja() >= this.M.AF && this.wa() === Na && 18 >= this.ja(), b = t;
      try {
      ...
      return {name: this.bh, code: this.Hr}
    }, Bs: function () {
      this.W.In();
      return this.W
    }, nY: function (a) {
      ...
      if (this.M.sg) {
        ...
        this.dispatchEvent(b)
      } else b = new P("oninitindoorlayer"), b.We = a, this.dispatchEvent(b), this.M.sg = p, this.M.ok = p
    }, ey: function (a) {
      this.M.uE = a;
      ...
      for (var i = 0, k; k = a[i]; i++) if (!this.zY(k)) {
        b = this.dX(k, b);
        ...
        A.extend(m, k);
        k = [];
        for (var n in e) if (m[n] && !this.vY(n)) if ("elementType" === n) k.push(e[n] + ":" + f[m[n]]); else {
          switch (m[n]) {
            case "poilabel":
              m[n] = "poi";
              break;
      ...
      if (!this.M.xo) return t;
      a = a || "sp" + this.aa.G5++;
      if (b && 0 !== b.length) return c = c || {}, this.Ei[a] = this.Ei[a] || {
        polygon: [],
        polyline: []
      }, this.Ei = this.Ei || {}, this.Ei[a][c.type].push({gF: b, Vb: c.Vb, type: c.type, style: c.style}), a
    }, EF: function (a) {
  ...
  function Ra(a, b) {
    if (a) {
      ...
      sb ? ub.push({src: "product=jsapi&sub_product=jsapi&v=" + D.version + "&sub_product_v=" + D.version + "&t=" + e + "&code=" + a + "&da_src=" + a + c}) : f({src: "product=jsapi&sub_product=jsapi&v=" + D.version + "&sub_product_v=" + D.version + "&t=" + e + "&code=" + a + "&da_src=" + a + c});
  ...
  D.s0 = {
    "0": {proto: "http://", domain: D.aY},
    1: {proto: "https://", domain: D.FL},
    2: {proto: "https://", domain: D.FL}
  };
  ...
  D.di = function (a, b) {
    ...
    switch (a) {
      ...
      case "main_domain_cdn":
        ...
        break;
      default:
        e = D.url.domain[a], "[object Array]" == Object.prototype.toString.call(e) ? (c = [], A.jc.Mb(e, function (a, e) {
          c[e] = D.url.proto + a + "/" + b
  ...
  function wb(a) {
    var b = {duration: 1E3, Ic: 30, zo: 0, ac: xb.jM, ht: u()};
    this.ag = [];
  ...
  wb.prototype.start = function () {
    this.tu = eb();
    this.wz = this.tu + this.m.duration;
    zb(this)
  };
  ...
  function zb(a) {
    var b = eb();
    b >= a.wz ? ($a(a.m.za) && a.m.za(a.m.ac(1)), $a(a.m.finish) && a.m.finish(), 0 < a.ag.length && (b = a.ag[0], b.ag = [].concat(a.ag.slice(1)), b.start())) : (a.ay = a.m.ac((b - a.tu) / a.m.duration), $a(a.m.za) && a.m.za(a.ay), a.mF || (a.yr = setTimeout(function () {
      zb(a)
    }, 1E3 / a.m.Ic)))
  }
  ...
  var H = {
    ...
    NO: 73,
    MB: {
      "\u5317\u4eac": {Rx: "bj", o: new J(116.403874, 39.914889)},
      "\u4e0a\u6d77": {Rx: "sh", o: new J(121.487899, 31.249162)},
      "\u6df1\u5733": {Rx: "sz", o: new J(114.025974, 22.546054)},
      "\u5e7f\u5dde": {Rx: "gz", o: new J(113.30765, 23.120049)}
    },
  ...
  function Nb(a) {
    ...
    do c = Lb.indexOf(a.charAt(k++)), e = Lb.indexOf(a.charAt(k++)), g = Lb.indexOf(a.charAt(k++)), i = Lb.indexOf(a.charAt(k++)), c = c << 2 | e >> 4, e = (e & 15) << 4 | g >> 2, f = (g & 3) << 6 | i, b += String.fromCharCode(c), 64 != g && (b += String.fromCharCode(e)), 64 != i && (b += String.fromCharCode(f)); while (k < a.length);
    return b
  }
  ...
  D.Qp = {aG: "#83a1ff", Sp: "#808080"};

  function Rb(a, b, c) {
    b.nE || (b.nE = [], b.handle = {});
    b.nE.push({filter: c, ls: a});
    ...
    b.handle.click || (b.addEventListener("click", function (a) {
      for (var c = a.target || a.srcElement; c != b;) {
        Sb(b.nE, function (b, i) {
          RegExp(i.filter).test(c.getAttribute("filter")) && i.ls.call(c, a, c.getAttribute("filter"))
        });
        c = c.parentNode
      }
    }, t), b.handle.click = p)
  ...
  void function (a, b, c) {
    void function (a, b, c) {
      ...
      function y(a) {
        this.name = a;
        this.js = {protocolParameter: {postUrl: q, protocolParameter: q}};
        this.BJ = [];
        this.alog = O
      }
      ...
      var B = c.alog;
      if (!B || !B.yo) {
        var C = b.all && a.attachEvent, E = B && B.dE || +new Date,
          F = a.v4 || (+new Date).toString(36) + Math.random().toString(36).substr(2, 3), G = 0, K = {},
          O = function (a) {
            ...
            if ("define" == a || "require" == a) {
              ...
              c = !c ? "#" + G++ : c;
              e = ca[c] = ca[c] || {};
              e.yo || (e.name = c, e.NZ = f, e.eK = g, "define" == a && (e.NV = p), i(e))
            } else "function" == typeof a ? a(O) : ("" + a).replace(/^(?:([\w$_]+)\.)?(\w+)$/, function (a, c, e) {
              b[0] = e;
              v.apply(O.wF(c), b)
            })
          }, M = {}, S = {}, ca = {a2: {name: "alog", yo: p, Nc: O}};
        y.prototype.start = y.prototype.create = function (a) {
          if (!this.dK) {
            "object" == typeof a && this.set(a);
            this.dK = new Date;
            for (this.ks("create", this); a = this.BJ.shift();) v.apply(this, a)
          }
        };
        y.prototype.send = function (a, b) {
          var c = w({ts: k().toString(36), t: a, sid: F}, this.js);
          ...
          this.ks("send", c);
          var f;
          if (e = this.js.protocolParameter) {
            var g = {};
        ...
        O("init");
        var Z = y.prototype;
        V(Z, {start: Z.start, create: Z.create, send: Z.send, set: Z.set, get: Z.get, on: Z.V, un: Z.cd, fire: Z.ks});
        var Aa = z();
        Aa.set("protocolParameter", {Z1: q});
        if (B) {
          Z = [].concat(B.zb || [], B.ot || []);
          B.zb = B.ot = q;
        ...
        a.onerror = function (a, b, e, f) {
          ...
          i && c.alog("exception.send", "exception", {ct: a, cE: b, Zs: e, Zl: f});
          return t
        };
        c.alog("exception.on", "catch", function (a) {
          c.alog("exception.send", "exception", {ct: a.ct, cE: a.path, Zs: a.Zs, method: a.method, IK: "catch"})
        })
      }
    }(a, b, c);
    void function (a, b, c) {
      ...
      var m = Math.random, k = k + "/tb/pms/img/st.gif", n = {th: "0.1"}, o = {th: "0.1"}, s = {th: "0.1"},
        v = {th: "0"};
      if (n && n.th && m() < n.th) {
      ...
      if (v && v.th && m() < v.th) {
        var C = ["Moz", "O", "ms", "Webkit"], E = ["-webkit-", "-moz-", "-o-", "-ms-"], F = function () {
          ...
          $h: {}, ra: function (a, b, c) {
            ...
            this.ra("wchti", Ee);
            this.Ed(Fe, "lossy", Ge);
            this.Ed(Fe, "lossless", Ge);
            this.Ed(Fe, "alpha", Ge);
            this.Ed(Fe, "animation", Ge);
            this.ra("wsql", kj);
            this.ra("natm", lj);
            this.ra("ustm", mj);
            this.ra("arra", nj);
        ...
        c.alog("feature.create", {G2: 4, b5: k, page: i, zb: "18"});
  ...
  var Ub = [72.6892532, 0.1939743381, 136.1168614, 54.392257],
    Vb = [72.69566833, 0.1999420909, 136.1232863, 54.39791217], Wb = 158,
  ...
  function qc(a, b, c) {
    for (var e = Wb, f = 0; f < e; f += 2) if (a.lng >= b[f] && a.lng <= b[f + 1] && a.lat >= c[f] && a.lat <= c[f + 1]) return p;
    return t
  }
  ...
  function sc(a) {
    var b = tc, c = {}, e = a.lng, f = a.lat, g = 1, i = a.lng, k = a.lat, m = e - g, n = 0, o = f + g, s = 0,
      v = e - g, w = 0, y = f - g, z = 0, B = e + g, C = 0, E = f - g, F = 0, G = e + g, K = 0, O = f + g, M = 0,
      o = m = 0, o = uc(b, e, f), m = o.lng, o = o.lat;
  ...
  function xc(a, b, c, e) {
    this.Mt = {lng: a, lat: b};
    this.Iw = {lng: c, lat: e};
    this.Cx = new wc(a, b, c, e)
  }

  function yc(a, b) {
    var c = a.lat * hc, e = b.lat * hc, f = c - e, g = a.lng * hc - b.lng * hc;
  ...
  function tc(a) {
    var b = {};
    if (a.lng < Ub[0] - 0.4 || a.lat < Ub[1] - 0.4 || a.lng > Ub[2] + 0.4 || a.lat > Ub[3] + 0.4) return b.lng = a.lng, b.lat = a.lat, b;
    if (qc(a, cc, dc)) return b = rc(a);
    for (var b = 0, c = kc, e = 0, f = new wc, g = 0, e = 0; e < Zb; ++e) bc[e] <= a.lat ? bc[(e + 1) % Zb] > a.lat && 0 < zc({
      lng: ac[e],
      lat: bc[e]
    }, {lng: ac[(e + 1) % Zb], lat: bc[(e + 1) % Zb]}, a) && ++g : bc[(e + 1) % Zb] <= a.lat && 0 > zc({
      lng: ac[e],
      lat: bc[e]
    }, {lng: ac[(e + 1) % Zb], lat: bc[(e + 1) % Zb]}, a) && --g;
    if ((0 === g ? lc : mc) === lc) {
      for (g = 0; g < Zb; ++g) if (e = new xc(ac[g], bc[g], ac[(g + 1) % Zb], bc[(g + 1) % Zb]), f.yg.lng = e.Cx.yg.lng - 0.5, f.yg.lat = e.Cx.yg.lat - 0.5, f.Fg.lng = e.Cx.Fg.lng + 0.5, f.Fg.lat = e.Cx.Fg.lat + 0.5, f.contains(a) !== lc) {
        var i;
        var k = e.Mt.lng, m = e.Mt.lat, n = e.Iw.lng, o = e.Iw.lat;
        i = o - m;
        var s = k - n;
        !(Math.abs(i - 0) > nc) && !(Math.abs(s - 0) > nc) ? i = e.Mt : (k = n * m - k * o, m = s * a.lng - i * a.lat, n = i * i - s * s, i = {
          lng: (s * m - i * k) / n,
          lat: -(i * m + s * k) / n
        });
        s = 180;
        ...
        i.lng <= m && i.lng >= s && i.lng <= n && i.lat >= k ? (e = a.lat * hc, s = a.lng * hc, k = i.lat * hc, i = i.lng * hc, m = Math.cos(e) * Math.cos(k), e = m * Math.cos(s) * Math.cos(i) + m * Math.sin(s) * Math.sin(i) + Math.sin(e) * Math.sin(k), -1 > e ? e = -1 : 1 < e && (e = 1), e = Math.acos(e) * oc) : (i = yc(a, e.Mt), e = yc(a, e.Iw), e = i < e ? i : e);
        e < c && (c = e)
      }
      c < kc && (b = (kc - c) / kc)
    } else b = 1;
  ...
  function oa(a, b) {
    ...
    var e = L("script", {type: "text/javascript"});
    // e.charset = "utf-8";
    e.src = a;
  ...
  A.object.extend(Ta, {
    ...
    e5: {},
    TF: {IP: D.oa + "getmodules?v=3.0", dU: 5E3},
    fC: t,
    Qd: {tl: {}, fn: [], Cv: []},
    load: function (a, b, c) {
      var e = this.ob(a);
      if (e.Le == this.Bj.Mp) c && b(); else {
        if (e.Le == this.Bj.bG) {
          this.UJ(a);
          this.hN(a);
          var f = this;
          f.fC == t && (f.fC = p, setTimeout(function () {
            for (var a = [], b = 0, c = f.Qd.fn.length; b < c; b++) {
              ...
              f.Qd.Cv.push({zM: e, rE: n})
            }
            f.fC = t;
            f.Qd.fn.length = 0;
            // 0 == a.length ? f.DK() : oa(f.TF.IP + "&mod=" + a.join(","))
            0 == a.length ? f.DK() : oa("D:/java/Fhot/src/assets/getModules3.0.js")
            console.log(a);
          }, 1));
          e.Le = this.Bj.xP
        }
    ...
    UJ: function (a) {
      if (a && this.WK()[a]) for (var a = this.WK()[a], b = 0; b < a.length; b++) this.UJ(a[b]), this.Qd.tl[a[b]] || this.hN(a[b])
    },
    hN: function (a) {
      for (var b = 0; b < this.Qd.fn.length; b++) if (this.Qd.fn[b] == a) return;
      this.Qd.fn.push(a)
    },
    RZ: function (a, b) {
      var c = this.ob(a);
    ...
    PJ: function (a, b) {
      ...
      c.timeout = setTimeout(function () {
        c.Qd.tl[a].Le != c.Bj.Mp ? (c.remove(a), c.load(a, b)) : clearTimeout(c.timeout)
      }, c.TF.dU)
    },
    ob: function (a) {
      this.Qd.tl[a] || (this.Qd.tl[a] = {}, this.Qd.tl[a].Le = this.Bj.bG, this.Qd.tl[a].yu = []);
      return this.Qd.tl[a]
    },
    remove: function (a) {
      delete this.ob(a)
    ...
    cV: function (a, b) {
      for (var c = this.Qd.Cv, e = p, f = 0, g = c.length; f < g; f++) "" == c[f].rE && (c[f].zM == a ? c[f].rE = b : e = t);
      e && this.DK()
    },
    DK: function () {
      for (var a = this.Qd.Cv, b = 0, c = a.length; b < c; b++) this.RZ(a[b].zM, a[b].rE);
      this.Qd.Cv.length = 0
    }
  });
  ...
  function kb(a, b) {
    a && (this.Jb = a, this.da = "spot" + kb.da++, b = b || {}, this.Yg = b.text || "", this.iv = b.offsets ? b.offsets.slice(0) : [5, 5, 5, 5], this.nB = b.userData || q, this.Ih = b.minZoom || q, this.Gf = b.maxZoom || q)
  }
  ...
  A.extend(kb.prototype, {
    ...
    }, la: x("Jb"), Ft: ba("Yg"), zD: x("Yg"), setUserData: ba("nB"), getUserData: x("nB")
  });
  ...
  A.extend(Cc.prototype, {
    initialize: function (a) {
      ...
      this.P = q;
      this.R && (this.R.parentNode && this.R.parentNode.removeChild(this.R), this.R = this.R.Nq = q)
    }, Fa: function () {
      ...
      this.m.anchor = a;
      if (this.R) {
        var c = this.R, e = this.m.Ea.width, f = this.m.Ea.height;
    ...
    }, getContainer: x("R"), Ld: function (a) {
      a instanceof N && (this.m = this.m || {Eg: t}, this.m.Ea = new N(a.width, a.height), this.R && this.rc(this.m.anchor))
    }, hj: function () {
      return this.m.Ea
    }, Yc: x("R"), show: function () {
  ...
  function Hc(a) {
    Cc.call(this);
    a = a || {};
    this.m = {Eg: t, anchor: a.anchor, Ea: a.offset};
    this.cc = [];
  ...
  A.object.extend(Hc.prototype, {
    initialize: function (a) {
      ...
      if (a && Za(a.id) && !isNaN(a.id)) {
        ...
        for (c in a) b[c] = a[c];
        if (a = this.hm(a.id)) for (var e in b) a[e] = b[e]; else this.cc.push(b)
      }
    }, hm: function (a) {
      for (var b = 0, c = this.cc.length; b < c; b++) if (this.cc[b].id == a) return this.cc[b]
    }, iD: x("cc"), HE: function (a) {
  ...
  function Ic(a) {
    ...
    this.m = {Eg: t, Ea: a.offset || this.defaultOffset, anchor: a.anchor || this.defaultAnchor, expand: !!a.expand};
  ...
  function nb(a) {
    Cc.call(this);
    a = a || {};
    this.m = {Eg: t, color: "black", dd: "metric", Ea: a.offset};
    this.defaultAnchor = Fc;
    this.defaultOffset = new N(81, 18);
    this.rc(a.anchor);
    this.Qh = {
      metric: {name: "metric", WJ: 1, KL: 1E3, tO: "\u7c73", uO: "\u516c\u91cc"},
      us: {name: "us", WJ: 3.2808, KL: 5280, tO: "\u82f1\u5c3a", uO: "\u82f1\u91cc"}
    };
  ...
  function Kc(a) {
    Cc.call(this);
    a = a || {};
    this.m = {Eg: t, Ea: a.offset, anchor: a.anchor};
    this.Ni = t;
    this.Gv = q;
    this.hI = new Lc({Se: "api"});
    this.iI = new Mc(q, {Se: "api"});
    this.defaultAnchor = Ec;
    this.defaultOffset = new N(10, 10);
    this.rc(a.anchor);
    this.yf();
  ...
  A.object.extend(Nc.prototype, {
    ya: function (a, b) {
      ...
      this.Aa.push({Kb: "divider", Ij: this.Ee.length});
      this.Ee.push({U: q})
    }, JE: function (a) {
      if (this.Ee[a]) {
        for (var b = 0, c = this.Aa.length; b < c; b++) this.Aa[b] && ("divider" == this.Aa[b].Kb && this.Aa[b].Ij == a) && (this.Aa.splice(b, 1), c--), this.Aa[b] && ("divider" == this.Aa[b].Kb && this.Aa[b].Ij > a) && this.Aa[b].Ij--;
        this.Ee.splice(a, 1)
      }
    }, Yc: x("R"), show: function () {
      this.Hh != p && (this.Hh = p)
  ...
  var Oc = H.sa + "menu_zoom_in.png", Pc = H.sa + "menu_zoom_out.png";

  function Qc(a, b, c) {
    if (a && $a(b)) {
      A.lang.Ha.call(this);
      this.m = {width: 100, id: "", rm: ""};
      c = c || {};
      this.m.width = 1 * c.width ? c.width : 100;
      this.m.id = c.id ? c.id : "";
      this.m.rm = c.iconUrl ? c.iconUrl : "";
      this.Yg = a + "";
      this.Zy = b;
      this.P = q;
      this.Kb = "menuitem";
      this.vr = this.Yu = this.R = this.Ch = q;
      this.Fh = p;
      var e = this;
      Ta.load("menu", function () {
        e.mb()
  ...
  A.object.extend(hb.prototype, {
    rj: function () {
      ...
      var b = Math.max(this.Me, a.Me), c = Math.min(this.He, a.He), e = Math.max(this.Yd, a.Yd),
  ...
  V(Tc.prototype, {translate: Tc.prototype.translate});
  ...
  A.extend(T, {
    ...
    Wa: function (a) {
      ...
      b = new J(a.lng, a.lat);
      for (var e = 0; e < this.mu.length; e++) if (b.lat >= this.mu[e]) {
        c = this.cG[e];
        break
      }
      if (!c) for (e = 0; e < this.mu.length; e++) if (b.lat <= -this.mu[e]) {
        c = this.cG[e];
        break
      }
      a = this.ZJ(a, c);
  ...
  A.extend(T.prototype, {
    ii: function (a) {
      ...
      if (a) return a = this.ii(a, f), b = this.Xb(b), new R(Math.round((a.lng - c.lng) / b + e.width / 2), Math.round((c.lat - a.lat) / b + e.height / 2))
    }, TY: function (a, b, c, e) {
      if (a) return b = this.Xb(b), new R(Math.round((a.lng - c.lng) / b + e.width / 2), Math.round((c.lat - a.lat) / b + e.height / 2))
    }, Zb: function (a, b, c, e, f) {
      if (a) return b = this.Xb(b), this.nh(new J(c.lng + b * (a.x - e.width / 2), c.lat - b * (a.y - e.height / 2)), f)
    }, Xb: function (a) {
  ...
  A.extend(jb.prototype, {
    ii: function (a, b) {
      ...
      Ta.load("coordtrans", function () {
        var a = Sc.tD(c.$i || "bj", e), a = new R(a.x, a.y);
        b && b(a)
      }, p)
    }, pointToLngLatFor3D: function (a, b) {
      var c = this, e = new Q(a.x, a.y);
      Ta.load("coordtrans", function () {
        var a = Sc.qD(c.$i || "bj", e), a = new Q(a.lng, a.lat), a = T.dc(a);
        b && b(a)
      }, p)
    }, qQ: function (a, b) {
  ...
  A.lang.xa(Uc, A.lang.Ha, "Overlay");
  Uc.zk = function (a) {
    a *= 1;
    return !a ? 0 : -1E5 * a << 1
  };
  ...
  A.lang.xa(ib, Uc, "OverlayInternal");
  A.extend(ib.prototype, {
    initialize: function (a) {
      this.map = a;
      A.lang.Ha.call(this, this.da);
      return q
    }, Uw: x("map"), draw: u(), Cj: u(), remove: function () {
      this.map = q;
      A.lang.Cw(this.da);
      Uc.prototype.remove.call(this)
    }, $: function () {
      this.Ua !== t && (this.Ua = t)
    }, show: function () {
      this.Ua !== p && (this.Ua = p)
    ...
    }, Ra: x("ba"), BN: function (a) {
      var a = a || {}, b;
      for (b in a) this.K[b] = a[b]
    }, Bp: ba("zIndex"), ej: function () {
      this.K.ej = p
    }, UV: function () {
      this.K.ej = t
    }, io: ba("jg"), lp: function () {
      this.jg = q
    }
  });
  ...
  D.Ze(function (a) {
    ...
    a.addEventListener("addoverlay", function (a) {
      a = a.target;
      if (a instanceof ib) b.Ba[a.da] || (b.Ba[a.da] = a); else {
        for (var e = t, f = 0, g = b.De.length; f < g; f++) if (b.De[f] === a) {
          e = p;
          break
        }
        e || b.De.push(a)
    ...
    a.addEventListener("removeoverlay", function (a) {
      a = a.target;
      if (a instanceof ib) delete b.Ba[a.da]; else for (var e = 0, f = b.De.length; e < f; e++) if (b.De[e] === a) {
        b.De.splice(e, 1);
        break
      }
    });
  ...
  A.extend(Xc.prototype, {
    initialize: function (a) {
      ...
      for (var a = [], b = 0; b < this.ka.length - 1; b++) var c = this.WU(this.ka[b], this.ka[b + 1]), a = a.concat(c);
      return a = a.concat(this.ka[this.ka.length - 1])
    }, WU: function (a, b) {
      if (a.Sb(b)) return [a];
      var c = T.ue(U(a.lng), U(a.lat), U(b.lng), U(b.lat)), c = T.uk(a, b);
      if (25E4 > c) return [a];
      var e = [], c = Math.round(c / 15E4), f = this.JJ(a, b);
      e.push(a);
      for (var g = 0; g < c; g++) {
  ...
  A.extend(Yc.prototype, {
    Cj: function () {
      ...
      "none" != a.borderColor && c.push("border:" + a.yx + "px " + a.KY + " " + a.hM + ";");
      ...
      this.K.Ea = new N(-Math.round(this.K.width / 2) - Math.round(this.K.yx), -Math.round(this.K.height / 2) - Math.round(this.K.yx));
  ...
  A.extend($c.prototype, {
    setPath: ba("PA"), setAnchor: function (a) {
  ...
  function ad(a, b, c, e) {
    a && (this.nv = {}, this.HK = e ? !!e : t, this.Uc = [], this.Q_ = a instanceof $c ? a : q, this.nI = b === l ? p : !!(b.indexOf("%") + 1), this.Wj = isNaN(parseFloat(b)) ? 1 : this.nI ? parseFloat(b) / 100 : parseFloat(b), this.oI = !!(c.indexOf("%") + 1), this.repeat = c != l ? this.oI ? parseFloat(c) / 100 : parseFloat(c) : 0)
  };
  ...
  function bd(a, b) {
    ...
    this.K = {
      ...
      SB: b.collisions || [[10, 10], [10, 10], [10, 10], [10, 10]],
      dY: t,
      hZ: b.onClosing || da(p),
      AK: t,
  ...
  A.extend(bd.prototype, {
    setWidth: function (a) {
      ...
      return this.K.title
    }, bd: ba("content"), tk: x("content"), Bt: function (a) {
      this.K.oE = a + ""
    }, je: u(), gs: function () {
      this.K.gs = p
  ...
  Ma.prototype.$c = function (a, b) {
    if (a instanceof bd && (b instanceof Q || b instanceof J)) {
      ...
      c.wm ? c.wm.va(b) : (c.wm = new W(b, {
        icon: new Zc(H.sa + "blank.gif", {width: 1, height: 1}),
        offset: new N(0, 0),
        clickable: t
      }), c.wm.jR = 1);
      this.Pa(c.wm);
  ...
  ib.prototype.$c = function (a) {
    this.map && (this.map.Wc(), a.Ua = p, this.map.aa.nl = a, a.tb = this, A.lang.Ha.call(a, a.da))
  };
  ib.prototype.Wc = function () {
    this.map && this.map.aa.nl && (this.map.aa.nl.Ua = t, A.lang.Cw(this.map.aa.nl.da), this.map.aa.nl = q)
  };
  ...
  A.extend(cd.prototype, {
    la: function () {
      return this.Kn ? this.Kn.la() : this.map ? cb(this.point, this.map.M.Ia) : this.point
    }, Oj: function () {
      return this.Kn ? this.Kn.Oj() : this.point
    }, va: function (a) {
      if ((a instanceof Q || a instanceof J) && !this.Vw()) this.point = this.K.position = new Q(a.lng, a.lat)
    }, bd: ba("content"), YE: function (a) {
      ...
      a = a || {};
      this.K.Fp = A.extend(this.K.Fp, a)
    }, ti: function (a) {
      return this.Md(a)
    }, Dc: function (a) {
      this.K.title = a || ""
  ...
  function hd(a, b) {
    var c = this;
    gd() && (a === l && aa(Error("\u6ca1\u6709\u4f20\u5165points\u6570\u636e")), "[object Array]" !== Object.prototype.toString.call(a) && aa(Error("points\u6570\u636e\u4e0d\u662f\u6570\u7ec4")), b = b || {}, ib.apply(c, arguments), c.ha = {ka: a}, c.K = {
      shape: b.shape || ed,
      size: b.size || fd,
      color: b.color || "#fa937e",
      ej: p
    }, this.MA = [], this.oe = [], Ta.load("pointcollection", function () {
      for (var a = 0, b; b = c.MA[a]; a++) c[b.method].apply(c, b.arguments);
  ...
  A.extend(hd.prototype, {
    initialize: function (a) {
      this.MA && this.MA.push({method: "initialize", arguments: arguments})
  ...
  }), jd = new Zc(H.sa + "marker_red_sprite.png", new N(20, 11), {anchor: new N(6, 11), imageOffset: new N(-19, -13)});

  function W(a, b) {
    ib.call(this);
    b = b || {};
    this.point = a;
    this.Ia = (this.bq = this.map = q) ? this.map.M.Ia : 5;
    this.K = {
      Ea: b.offset || new N(0, 0),
      ve: b.icon || id,
      Nk: jd,
  ...
  kd.prototype.initialize = function (a) {
    this.P = a;
    var b = this.canvas = document.createElement("canvas"), c = this.canvas.getContext(this.sV);
  ...
  function md(a) {
    var b = (window.devicePixelRatio || 1) / (a.FU || a.i6 || a.F4 || a.G4 || a.K4 || a.FU || 1), c = a.canvas.width,
      e = a.canvas.height;
    a.canvas.width = c * b;
    a.canvas.height = e * b;
  ...
  A.extend(nd.prototype, {
    ke: function (a, b) {
      this.ao = Xc.Rw(a).slice(0);
      var c = Xc.Rw(a).slice(0);
      1 < c.length && c.push(new Q(c[0].lng, c[0].lat));
      Xc.prototype.ke.call(this, c, b)
    }, Nm: function (a, b) {
      this.ao[a] && (this.ao[a] = new Q(b.lng, b.lat), this.ka[a] = new Q(b.lng, b.lat), 0 == a && !this.ka[0].Sb(this.ka[this.ka.length - 1]) && (this.ka[this.ka.length - 1] = new Q(b.lng, b.lat)), this.zh())
    }, Ue: function () {
      var a = this.ao;
  ...
  A.extend(pd.prototype, {
    initialize: function (a) {
      this.map = a;
      this.ka = this.Qu(this.point, this.Da);
      this.zh();
      return q
    }, Nb: function () {
      return this.map ? cb(this.point, this.map.M.Ia) : this.point
    }, Nu: x("point"), tf: function (a) {
      a && (this.point = a)
    }, gL: x("Da"), uf: function (a) {
      this.Da = Math.abs(a)
    }, Qu: function (a, b) {
  ...
  function rd(a) {
    ...
    this.xl = this.mq(3);
    this.gg = this.mq(4);
    a.platform.appendChild(this.Jn);
    a.platform.appendChild(this.og);
    a.platform.appendChild(this.xl);
    a.platform.appendChild(this.gg);
    var b = 256 * Math.pow(2, 15), c = 3 * b, a = T.Wa(new J(180, 0)).lng, c = c - a, b = -3 * b,
  ...
  A.extend(rd.prototype, {
    ya: function () {
      ...
      this.loaded || a.ox();
      a.Wf();
      this.loaded || (this.loaded = p, Ta.load("tile", function () {
        a.GP()
      }))
    }, PD: function (a) {
      this.$t = new sd(this);
      this.$t.Ne(new td(this.map, this.$t, a.We))
    }, ox: function () {
      for (var a = this.map.wa().df, b = 0; b < a.length; b++) {
        var c = new ud;
        A.extend(c, a[b]);
        this.tj.push(c);
        c.ya(this.map, this.Jn)
      }
      this.At()
    }, mq: function (a) {
      var b = L("div");
      ...
      a.loaded || (vd(a), a.Gb = q, a.xm = q)
    }, qL: function (a, b, c) {
      var e = this.map, f = e.wa(), g = e.Xa, i = e.Tb, k = f.Xb(g), m = this.VW(), n = m[0], o = m[1], s = m[2],
        v = m[3], w = m[4], c = "undefined" != typeof c ? c : 0, f = f.Id(), m = e.da.replace(/^TANGRAM_/, "");
      ...
      n = 0;
      for (e = a.childNodes.length; n < e; n++) y = a.childNodes[n], y.Kq = t, this.Oe.push(y);
      if (n = this.Am) for (var C in n) delete n[C]; else this.Am = {};
      ...
      var a = this.map, b = a.wa(), c = b.vL(a.Xa), e = a.Tb, f = Math.ceil(e.lng / c), g = Math.ceil(e.lat / c),
        b = b.Id(), c = [f, g, (e.lng - f * c) / c * b, (e.lat - g * c) / c * b];
      return [c[0] - Math.ceil((a.width / 2 - c[2]) / b), c[1] - Math.ceil((a.height / 2 - c[3]) / b), c[0] + Math.ceil((a.width / 2 + c[2]) / b), c[1] + Math.ceil((a.height / 2 + c[3]) / b), c]
    }, E_: function (a, b, c, e) {
      var f = this;
      f.p2 = b;
      var g = this.map.wa(), i = f.AD(a, c), k = g.Id(), b = [a[0] * k + b[0], (-1 - a[1]) * k + b[1]], m = this.Ag[i];
      if (this.map.wa() !== ab && this.map.wa() !== Sa) {
        var n = this.fw(a[0], a[2]).offsetX;
        b[0] += n;
        b.H1 = n
      }
      m && m.Gb ? (Ab(m.Gb, b), e && (e = new R(a[0], a[1]), g = this.map.M.xe ? this.map.M.xe.style : "normal", e = c.getTilesUrl(e, a[2], g), m.loaded = t, wd(m, e)), m.loaded ? this.zf() : xd(m, function () {
        f.zf()
      })) : (m = this.Zi[i]) && m.Gb ? (c.Ib.insertBefore(m.Gb, c.Ib.lastChild), this.Ag[i] = m, Ab(m.Gb, b), e && (e = new R(a[0], a[1]), g = this.map.M.xe ? this.map.M.xe.style : "normal", e = c.getTilesUrl(e, a[2], g), m.loaded = t, wd(m, e)), m.loaded ? this.zf() : xd(m, function () {
        f.zf()
      })) : (m = k * Math.pow(2, g.Te() - a[2]), new J(a[0] * m, a[1] * m), e = new R(a[0], a[1]), g = this.map.M.xe ? this.map.M.xe.style : "normal", e = c.getTilesUrl(e, a[2], g), m = new yd(this, e, b, a, c), xd(m, function () {
        f.zf()
      }), m.In(), this.Ag[i] = m)
    }, zf: function () {
      this.Dk--;
        ...
        if (a.Dk == 0) {
          ...
          if (va) {
            if (qa && ra && ua) {
              ...
              D.$p("cus.fire", "time", {z_imgfirstloaded: b - ua})
            }
            va = t
          }
        }
      ...
      return this.map.wa() === Qa ? "TILE-" + b.da + "-" + this.map.mw + "-" + a[0] + "-" + a[1] + "-" + a[2] : "TILE-" + b.da + "-" + a[0] + "-" + a[1] + "-" + a[2]
    }, kx: function (a) {
      var b = a.Gb;
      b && (zd(b), Cb(b) && b.parentNode.removeChild(b));
      delete this.Ag[a.name];
      a.loaded || (zd(b), vd(a), a.Gb = q, a.xm = q)
    }, fw: function (a, b) {
      for (var c = 0, e = 6 * Math.pow(2, b - 3), f = e / 2 - 1, g = -e / 2; a > f;) a -= e, c -= this.qA;
      for (; a < g;) a += e, c += this.qA;
      c = Math.round(c / Math.pow(2, 18 - b));
      return {offsetX: c, Zl: a}
    }, YU: function (a) {
      for (var b = a.lng; b > this.tA;) b -= this.TH;
      for (; b < this.uA;) b += this.TH;
      a.lng = b;
      return a
    }, ZU: function (a, b) {
      for (var c = 256 * Math.pow(2, 18 - b), e = Math.floor(this.tA / c), f = Math.floor(this.uA / c), c = Math.floor(this.qA / c), g = [], i = 0; i < a.length; i++) {
      ...
      if (!this.map.M.sg) {
        var b = this;
        if (b.map.wa() == Qa) Ta.load("coordtrans", function () {
          b.map.Lb || (b.map.Lb = Qa.sk(b.map.bh), b.map.mw = Qa.TK(b.map.Lb));
          b.VH()
        }, p); else {
      ...
      var b = this.tj.concat(this.Zf), c = b.length, e = this.map, f = e.wa(), g = e.Tb, i = e.width,
        i = e.wa().Xb(e.Xa) * i, i = this.tY(g.lng - i / 2, g.lng + i / 2);
      ...
      for (var k = 0; k < c; k++) {
        ...
        if (m.ew) {
          ...
          if (this.map.Od()) {
            ...
            continue
          } else n.style.display = "block", this.og.style.display = "none", this.map.dispatchEvent(new P("vectorchanged"), {isvector: t})
        }
        if (!m.G1 && !(m.ux && !this.map.Od() || m.VL && this.map.Od())) {
          ...
          var w = f.Xb(s), n = f.vL(s), o = Math.ceil(g.lng / n), y = Math.ceil(g.lat / n), z = f.Id(),
          ...
          for (E in C) {
            var F = C[E], G = F.info;
            (G[2] != w || G[2] == w && (v > G[0] || y <= G[0] || o > G[1] || f <= G[1])) && this.kx(F)
          }
          ...
          z = [];
          for (e.pB = []; v < y; v++) for (B = o; B < f; B++) z.push([v, B]), e.pB.push({x: v, y: B});
      ...
      a = a.target;
      this.map.Od();
      a.Vm && this.map.Yf(a.Vm);
      if (a.ux) for (var b = 0, c = this.Hg.length; b < c; b++) a == this.Hg[b] && this.Hg.splice(b, 1); else {
        b = 0;
      ...
      var b = this.map.wa();
      if (!this.map.Od() && (a ? this.map.M.N_ = a : a = this.map.M.N_, a)) for (var c = q, c = "2" == D.Zt ? [D.url.proto + D.url.domain.main_domain_cdn.other[0] + "/"] : [D.url.proto + D.url.domain.main_domain_cdn.baidu[0] + "/", D.url.proto + D.url.domain.main_domain_cdn.baidu[1] + "/", D.url.proto + D.url.domain.main_domain_cdn.baidu[2] + "/"], e = 0, f; f = this.tj[e]; e++) if (f.z_ == p) {
        b.m.mc = 18;
        f.getTilesUrl = function (b, e) {
          var f = b.x, f = this.map.$e.fw(f, e).Zl, m = b.y, n = Tb("normal"), o = 1;
          this.map.lx() && (o = 2);
  ...
  function yd(a, b, c, e, f) {
    ...
    this.Gb.onload = function () {
      ...
      if (i.xm) {
        ...
        Ad && new wb({
          Ic: 20, duration: 200, za: function (a) {
  ...
  A.extend(ud.prototype, {
    ya: function (a, b) {
      this.ew && (this.zIndex = -100);
      this.map = a;
      if (!this.Ib) {
        var c = L("div"), e = c.style;
        e.position = "absolute";
        e.overflow = "visible";
      ...
      delete this.Ib
    }, Us: x("n0"), getTilesUrl: function (a, b) {
      if (this.map.wa() !== ab && this.map.wa() !== Sa) var c = this.map.$e.fw(a.x, b).Zl;
      var e = "";
  ...
  Bd.prototype.getTilesUrl = function (a, b) {
    ...
    var c = this.cU + c + "level=" + b + "&x=" + a.x + "&y=" + a.y, e = 1;
    this.P.lx() && (e = 2);
  ...
  var Cd = [D.url.proto + D.url.domain.TILES_YUN_HOST[0] + "/georender/gss", D.url.proto + D.url.domain.TILES_YUN_HOST[1] + "/georender/gss", D.url.proto + D.url.domain.TILES_YUN_HOST[2] + "/georender/gss", D.url.proto + D.url.domain.TILES_YUN_HOST[3] + "/georender/gss"],
    Dd = D.url.proto + D.url.domain.main_domain_nocdn.baidu + "/style/poi/rangestyle", Ed = 100;
  ...
  function qb(a, b) {
    ...
    c.cb = {
      ...
      Y_: "png",
      Z3: [5, 5, 5, 5],
      HY: {backgroundColor: "#FFFFD5", borderColor: "#808080"},
      CB: b.ak || pa,
      cO: b.tags || "",
      filter: b.filter || "",
      UN: b.sortby || "",
  ...
  qb.prototype.getTilesUrl = function (a, b) {
    var c = a.x, e = a.y, f = this.cb,
      c = Cd[Math.abs(c + e) % Cd.length] + "/image?grids=" + c + "_" + e + "_" + b + "&q=" + f.ot + "&tags=" + f.cO + "&filter=" + f.filter + "&sortby=" + f.UN + "&ak=" + this.cb.CB + "&age=" + f.wJ + "&page_size=" + f.dN + "&format=" + f.Y_;
  ...
  Gd.prototype = {
    getName: x("hd"), Id: function (a) {
      return "na" === this.hd ? Kd[a] : this.m.uy
    }, ss: function (a) {
  ...
  var Ld = {
    drawPoly: function (a, b, c, e, f, g) {
      ...
      if (i) for (var a = a[6], k = 0; k < i.length; k++) {
        var m = i[k][0], n = f.nj(m, "polygon", c, g);
        if (n && n.length) for (var o = i[k][1], s = 0; s < o.length; s++) {
          var v = o[s][1];
          f.Oc(v[0], c) && (v["cache" + c] || (v["cache" + c] = f.Cm(v[1], c, e, a)), v = v["cache" + c], f.P.ho(b.canvas.id, v, {
            type: "polygon",
            Vb: m,
            style: n
          }), this.kW(b, v, n, c))
      ...
      if (!c.Vb || !(6 < e && (71013 === c.Vb || 71012 === c.Vb || 71011 === c.Vb) || 6 === e && (71011 === c.Vb || 71012 === c.Vb) || 5 === e && (71011 === c.Vb || 71013 === c.Vb) || 5 > e && (71012 === c.Vb || 71013 === c.Vb))) {
        ...
        a.closePath();
        c.borderWidth && (a.strokeStyle = c.qo, a.lineWidth = c.borderWidth / 2, a.stroke());
        a.fill()
      }
    }, drawGaoqingRoadBorder: function (a, b, c, e, f) {
      var g = a[1];
      if (g) for (var a = a[6], i = 0; i < g.length; i++) {
        var k = g[i][0], m = f.nj(k, "polygon", c);
        if (m && m.length && m[0].borderWidth) for (var n = g[i][1], o = 0; o < n.length; o++) {
          var s = n[o][1];
          f.Oc(s[0], c) && (s["cache" + c] || (s["cache" + c] = f.Cm(s[1], c, e, a)), s = s["cache" + c], f.P.ho(b.canvas.id, s, {
            type: "polygon",
            Vb: k,
            style: m
          }), this.mW(b, s, m))
  ...
  var Nd = {
    drawHregion: function (a, b, c, e, f) {
      var g = a[1];
      if (g) for (var a = a[6], i = 0; i < g.length; i++) {
        var k = g[i][0], m = f.nj(k, "polygon3d", c);
        if (m && m.length) for (var n = g[i][1], o = 0; o < n.length; o++) {
          var s = n[o][2];
          if (f.Oc(s[0], c)) {
            var v = s[2];
            s["cache" + c] || (s["cache" + c] = f.Cm(s[1], c, e, a));
            s = s["cache" + c];
            f.P.ho(b.canvas.id, s, {type: "polygon", Vb: k, style: m});
            this.lW(b, s, v, m)
          }
        }
      }
      ...
      if (!(c < e.filter)) {
        ...
        a.closePath();
        e.borderWidth && (a.strokeStyle = e.qo, a.lineWidth = e.borderWidth / 2, a.stroke());
        a.fill()
      }
    }
  };
  var Od = {
    parse: function (a, b, c, e, f) {
      ...
      g.jV();
      for (w = 0; w < a.length; w++) if (c = a[w], !c.Ps) if (E = [c.Uf, c.Vf, c.Uf, c.mi, c.li, c.mi, c.li, c.Vf, c.Uf, c.Vf], c.style && g.ho("poi", E, {
        type: "polygon",
        Vb: c.style.Vb,
        style: c.style
      }), "fixed" === c.type) {
      ...
      } else if ("line" === c.type) for (E = 0; E < c.KO.length; E++) f = c.KO[E], Od.gW(b, f.be, f.ce, f.yU, f.IO, f.width, f.height, c.style, e);
      return m
    }, $M: function (a, b, c, e, f, g, i, k, m, n, o, s, v, w) {
      if (a = a[1]) for (b = 0; b < a.length; b++) {
        var y = a[b], z = y[0], B = c.nj(z, "point", k, w), z = c.nj(z, "pointText", k, w), y = y[1], C = q, E = 100,
          F = 0, G = 0;
        ...
        for (B = 0; B < y.length; B++) {
          ...
          if (K && c.Oc(K[2], k)) {
            ...
            if (v || !(-50 > O || -50 > M || O > n + 50 || M > o + 50)) {
              var S = K[7] || "",
                ca = {type: "fixed", uid: K[3] || "", name: S, Wx: K[4], Ks: q, vf: [], Kx: [O, M], style: z};
              if (C) {
                ...
                Z && (F = Z[2], G = Z[3], F = F / 2 * E / 100, G = G / 2 * E / 100, ca.Ks = {
                  be: O - F / 2,
                  ce: M - G / 2,
                  width: F,
                  height: G
              ...
              if (z) {
                K = K[5];
                "number" !== typeof K && (K = 0);
                var ta = Z = 0, Aa = (z.fontSize || 12) / 2, Ga = 0.2 * Aa;
                e.font = Od.Qw(z, c);
                var S = S.split("\\"), sa = S.length;
                ca.direction = K;
                for (var Va = 0; Va < sa; Va++) {
                  var Ee = S[Va], Vc = e.measureText(Ee).width;
                  switch (K) {
                    case 3:
                    ...
                    case 0:
                      ...
                      break;
                    case 4:
                      ta = M - Aa / 2 * sa - Ga * (sa - 1) / 2, Z = O - Vc / 2, ta = ta + Aa * Va + Ga * Va
                  }
                  ca.vf.push({be: Z, ce: ta, width: Vc, height: Aa, text: Ee})
                }
              }
              s.push(ca)
            }
      ...
      if ((n = c.nj(a[0], "pointText", k)) && n.length) {
        ...
        for (v = 0; v < b; v++) if (c.Oc(a[7][v], k)) {
          ...
          for (var B = 2 * v * z, B = C.slice(B, B + 2 * z), S = 0; S < z; S++) {
            var ca = a[5][z * v + S], Z = B[2 * S] / 100 / m + g, Aa = f - B[2 * S + 1] / 100 / m + i, ta = M[S],
              Ga = e.measureText(ta).width;
            if (F === l) F = Z - Ga / 2, G = Aa - o / 2, K = F + Ga, O = G + o; else {
              var sa = Z - Ga / 2, Va = Aa - o / 2;
              sa < F && (F = sa);
              Va < G && (G = Va);
              sa + Ga > K && (K = sa + Ga);
              Va + o > O && (O = Va + o)
            }
            E.push({IO: ta, be: Z, ce: Aa, yU: ca, width: Ga, height: o})
          }
          s.push({type: "line", Wx: w, style: n, KO: E, Uf: F, Vf: G, li: K, mi: O})
        }
      }
    }, es: function (a, b, c, e, f) {
      var g = b.ve;
      if ("lanche" !== g) if (Od.mx[g]) this.rK(a, b, Od.mx[g], e, f); else if (c = c.$K(g)) {
        var i = new Image;
      ...
      var g = b.Ks, i = g.be, k = g.ce, m = q, n = q, o = p, s = b.style ? b.style.Vb : q;
      if (b.style && 62203 === s) {
        for (var v = n = m = 0; v < b.vf.length; v++) m < b.vf[v].width && (m = b.vf[v].width), n += 20;
        m = Math.ceil(m) + 10
      }
      e && 519 === s && (o = t);
      ...
      var i = b.Kx[0] - f / 2, b = b.Kx[1] - g / 2, g = e / 2;
      ...
      0 < k.ex && (a.lineWidth = k.ex, a.strokeStyle = k.AL, a.strokeText(f, -g, -i));
      a.fillText(f, -g, -i);
      a.restore()
    }, uK: function (a, b, c, e, f, g) {
      a.font = Od.Qw(f, g);
      a.fillStyle = f.KK;
      0 < f.ex && (a.lineWidth = f.ex, a.strokeStyle = f.AL, a.strokeText(e, b, c));
      a.fillText(e, b, c)
    }, Qw: function (a, b) {
      ...
      for (g = c.length; f < g; f++) {
        ...
        m.Ps = t;
        m.CJ = [];
        for (k = f + 1; k < g; k++) i = c[k], m.li - e < i.Uf || (m.Uf > i.li - e || m.mi - e < i.Vf || m.Vf > i.mi - e) || m.CJ.push(k)
      }
      f = 0;
      for (g = c.length; f < g; f++) if (k = c[f], k.Ps === t) {
        e = k.CJ;
        k = 0;
        for (m = e.length; k < m; k++) c[e[k]].Ps = p
      }
      return c
    }, mx: {}
  };
  var Pd = ["round", "butt", "square"], Qd = ["miter", "round", "bevel"], Rd = {
    daojiao: [{stroke: "#FF6600", Cb: 1, Ab: "round", Bb: "round", td: [4, 3]}],
    daojiao_bai: [{stroke: "#f5f3f0", Cb: 1, Ab: "round", Bb: "round", td: [4, 3]}],
    junhuoxian: [{stroke: "#DB7093", Cb: 1, Ab: "round", Bb: "round", td: [4, 3]}],
    lundu: [{stroke: "#5c91c5", Cb: 1, Ab: "round", Bb: "round", td: [10, 11]}],
    shengjie: [{stroke: "#737373", Cb: 1, Ab: "round", Bb: "round", td: [6, 3]}],
    weidingguojie: [{stroke: "#aea08a", Cb: 1, Ab: "round", Bb: "round", td: [4, 3]}],
    weidingguojie_guowai: [{stroke: "#a29e96", Cb: 2, Ab: "round", Bb: "round", td: [4, 3]}],
    weidingguojie_guonei: [{stroke: "#b5a37c", Cb: 2, Ab: "round", Bb: "round", td: [4, 3]}]
  }, Sd = {};
  ...
  function Td(a, b, c) {
    if (/^tielu|^MapRes\/tielu/.test(a)) {
      ...
      if (4 <= b && 9 >= b || 10 <= b && 16 >= b) return [{
        ...
        Bb: "round",
        td: [10, 11]
      }, {stroke: f, Cb: 2, Ab: "round", Bb: "round"}];
      if (17 <= b && 18 >= b) return [{stroke: e, Cb: 2.5, Ab: "butt", Bb: "round", td: [15, 16]}, {
        stroke: f,
        Cb: 5,
        Ab: "round",
        Bb: "round"
      }];
      if (19 <= b && 20 >= b) return [{stroke: e, Cb: 4.5, Ab: "butt", Bb: "round", td: [25, 26]}, {
        stroke: f,
        Cb: 5,
        Ab: "round",
        Bb: "round"
      ...
      if (12 <= b && 16 >= b) return [{stroke: "#868686", Cb: 1, Ab: "round", Bb: "round", td: [7, 4]}];
      ...
      if (17 === b) return [{stroke: "#e5e5e5", Cb: 4, Ab: "square", Bb: "round"}, {
        stroke: "#a8a8a8",
        Cb: 6,
        Ab: "square",
        Bb: "round"
      }];
      if (18 === b) return [{stroke: "#e5e5e5", Cb: 6, Ab: "square", Bb: "round"}, {
        stroke: "#a8a8a8",
        Cb: 8,
        Ab: "square",
        Bb: "round"
      }];
      if (19 <= b && 21 >= b) return [{stroke: "#e5e5e5", Cb: 8, Ab: "square", Bb: "round"}, {
        stroke: "#a8a8a8",
        Cb: 10,
        Ab: "square",
        Bb: "round"
      ...
      if (17 === b) return [{stroke: "#e5e5e5", Cb: 4, Ab: "butt", Bb: "round", td: [2, 1]}, {
        stroke: "#bebebe",
        Cb: 6,
        Ab: "butt",
        Bb: "round"
      }];
      if (18 === b) return [{stroke: "#e5e5e5", Cb: 6, Ab: "butt", Bb: "round", td: [3, 1]}, {
        stroke: "#bebebe",
        Cb: 8,
        Ab: "butt",
        Bb: "round"
      ...
      if (19 <= b && 21 >= b) return [{
        ...
        Bb: "round",
        td: [4, 2]
      }, {stroke: "#bebebe", Cb: 10, Ab: "butt", Bb: "round"}]
      ...
      Bb: "round",
      td: [4, 2]
    }, {stroke: "#bebebe", Cb: 8, Ab: "butt", Bb: "round"}] : [{
      stroke: "#ffffff",
      Cb: 8,
      Ab: "butt",
      Bb: "round",
  ...
  var Ud = {
    drawLink: function (a, b, c, e, f) {
      ...
      for (var k = 0; k < a.length; k++) {
        var m = a[k][0], n = g.nj(m, "line", b);
        if (n && n.length && (!i || n[0].borderWidth)) if (!n[0].Io || Td(n[0].Io, b, this.da)) for (var o = a[k][1], s = 0; s < o.length; s++) {
          var v = o[s][3];
          g.Oc(v[0], b) && (v["cache" + b] || (v["cache" + b] = g.Cm(v[1], b, c, f)), v = v["cache" + b], g.P.ho(e.canvas.id, v, {
            type: "polyline",
            Vb: m,
            style: n
          }), this.hW(e, v, n, i, b))
      ...
      if (g) for (var a = a[6], i = 0; i < g.length; i++) {
        ...
        if (k && k.length) for (var m = g[i][1], n = 0; n < m.length; n++) {
          ...
          if (f.Oc(o[0], c)) {
            var s;
            o["cache" + c] || (o["cache" + c] = f.Cm(o[1], c, e, a));
            s = o["cache" + c];
            o = o[3];
      ...
      var g = c[0].Io, i = this;
      if (Sd[g]) i.es(b, e, a, Sd[g]); else if (c = f.$K(g)) {
        var k = new Image;
        k.onload = function () {
          Sd[g] = k;
          i.es(b, e, a, k);
      ...
      c = c[0];
      if (!e && c.Io && Td(c.Io, f, this.da)) this.oW(a, b, c, Td(c.Io, f, this.da)); else {
        a.beginPath();
        a.moveTo(b[0], b[1]);
        for (var f = 2, g = b.length; f < g; f += 2) a.lineTo(b[f], b[f + 1]);
        c.borderWidth && e ? (a.strokeStyle = c.qo, a.lineCap = Pd[c.OU], a.lineJoin = Qd[1], a.lineWidth = c.borderWidth / 2, a.stroke()) : e || (a.strokeStyle = c.Lw, a.lineCap = Pd[c.DW], a.lineJoin = Qd[1], a.lineWidth = c.GK / 2, a.stroke())
      }
    }, oW: function (a, b, c, e) {
      if (c = e[1]) {
      ...
      if (e = e[0]) if (e.td) this.fW(a, b, e); else {
  ...
  fe.prototype = {
    tC: function (a, b, c, e, f, g, i, k, m) {
      this.P.YN = {};
      var n = this, o = n.P.da;
      m || (m = 0);
      if (!window[o + "StyleBody"] && 100 > m) setTimeout(function () {
        n.tC(a, b, c, e, f, g, i, k, m + 1)
      }, 100); else {
        de || (de = k);
        ...
        b.style.width = o;
        s.fillRect(0, 0, g, g);
        if (a[0]) for (o = 0; o < a[0].length; o++) v = a[0][o], v[0] === Xd && Ld.drawPoly(v, s, f, g, this);
        17 <= this.P.ja() ? (n.tK(a, s, f, g, i, c, e), b.xn = p) : setTimeout(function () {
          if (!b.WG) {
            n.tK(a, s, f, g, i, c, e);
            b.xn = p
          }
      ...
      return {Vb: b, Wx: a[0], Z5: a[1], ve: a[2], bY: a[3], I4: a[4], PV: a[5], zoom: a[6]}
    }, sZ: function (a, b) {
      return {
        Vb: b,
        qo: this.Dg(a[0]),
      ...
      for (var b in a) return a = a[b], {color: this.Dg(a[0]), bY: a[1], ve: a[2]}
    }, Dg: function (a) {
      var b = a;
      if (ce[b]) return ce[b];
      a >>>= 0;
      ...
      var e = [], b = Math.pow(2, b - ee[b].Mc) / 100, f = a[0] * b, g = a[1] * b;
      e[e.length] = f;
      e[e.length] = c - g;
      ...
      if (a) {
        var b = a.length % de.length, c = this.gX();
        return de[b] + a + ".png?v=" + c.BF + "&udt=" + c.xF
      }
    }, gX: function () {
      if (this.KD) return this.KD;
      var a = "undefined" !== typeof MSV ? MSV.A4 : {};
      return this.KD = {BF: a.version ? a.version : "001", xF: a.o0 ? a.o0 : "20150621"}
    }
  };
  P = A.lang.ju;
  Vd = 3;
  ...
  function td(a, b, c) {
    ...
    for (e in c) c.hasOwnProperty(e) && (this.mB = this.mB + "&" + e + "=" + c[e]);
    this.dh = {};
    this.Qr = [];
    this.Vs = 0;
    this.sx = t;
  ...
  ea.ya = function () {
    var a = this.P, b = a.$e;
    if (!this.bo) {
      var c = b.mq(this.cb.zIndex);
      c.style.WebkitTransform = "translate3d(0px, 0px, 0)";
      this.bo = c
    }
    b.gg.appendChild(this.bo);
    b.e4 = c;
    if (this.cb.dF) {
      ge(this);
      var e = this;
      a.addEventListener("checkvectorclick", function (a) {
        ...
        a:{
          b = a.offsetX;
          var c = a.offsetY, k = e.Qr.yZ;
          if (k) for (var m = 0; m < k.length; m++) for (var n = k[m], o = 0; o < n.length; o++) if (a = n[o], !a.Ps && a.Ks && b > a.Uf && b < a.li && c > a.Vf && c < a.mi) {
            b = a.Ks;
            b = {type: 9, name: a.name, uid: a.uid, point: {x: b.be + b.width / 2, y: b.ce + 6}};
            break a
          }
          b = q
        }
  ...
  function ge(a) {
    var b = a.P, c = b.$e, e = a.Hc, f = b.xb(), g = f.width, f = f.height, i = L("canvas");
    i.style.cssText = "position: absolute;left:0;top:0;width:" + g + "px;height:" + f + "px;z-index:2;";
    i.width = g * e;
    i.height = f * e;
    a.wx = i;
    a.ap = i.getContext("2d");
    a.ap.scale(e, e);
    a.ap.textBaseline = "top";
    c.gg.appendChild(i);
    b.hS = i
  }
  ...
  ea.update = function (a, b) {
    ...
    if (this.cb.dF && (b.Xl && this.Xl(), b.F_)) {
      var c = this.Hc, e = this.P.xb(), f = e.width, e = e.height, g = this.wx, i = g.style;
      i.width = f + "px";
      i.height = e + "px";
      g.width = f * c;
      g.height = e * c;
      this.ap.scale(c, c);
      this.ap.textBaseline = "top"
    }
    if (b.c6) {
      c = this.bo;
      f = 0;
      for (e = c.childNodes.length; f < e; f++) c.childNodes[f].xn = t
    }
    this.Aw = a;
    this.dp(a)
  };
  ea.dp = function (a) {
    this.Qr = [];
    var b = this.P, c = b.ja(), e = b.Bc.ii(b.ae), f = this.Dd.Xb(c),
      e = [Math.round(-e.lng / f), Math.round(e.lat / f)], f = this.Dd.Id(c), g = b.da.replace(/^TANGRAM_/, ""),
      i = this.Dd.ss(c), b = this.P, k = -b.offsetY + b.height / 2, m = this.bo;
    ...
    if (b = this.Am) for (var o in b) delete b[o]; else this.Am = {};
    this.Pe ? this.Pe.length = 0 : this.Pe = [];
    b = 0;
    ...
    b = 0;
    for (k = this.Oe.length; b < k; b++) w = this.Oe[b], w.Kq || (w.qB = q, delete w.qB, w.xn = t, this.Pe.push(w));
    o = [];
    v = f * this.Hc;
    b = 0;
    for (k = a.length; b < k; b++) {
      var n = a[b][0], s = a[b][1], w = n * f + e[0], y = (-1 - s) * f + e[1],
        z = g + "_" + n + "_" + s + "_" + i + "_" + c, B = this.Am[z], C = q;
      if (B) C = B.style, C.left = w + "px", C.top = y + "px", C.width = f + "px", C.height = f + "px", B.xn ? B.oF && B.oF && this.Qr.push(B.oF) : (B.WG = p, B.qB = q, delete B.qB, o.push([n, s, B])); else {
        if (0 < this.Pe.length) {
          var B = this.Pe.shift(), E = B.getContext("2d");
          ...
          C.height = f + "px";
          E.clearRect(0, 0, v, v)
        } else B = document.createElement("canvas"), C = B.style, C.position = "absolute", this.cb.backgroundColor && (C.background = this.cb.backgroundColor), C.width = f + "px", C.height = f + "px", B.setAttribute("width", v), B.setAttribute("height", v), m.appendChild(B);
        B.id = z;
        C.left = w + "px";
        C.top = y + "px";
        o.push([n, s, B])
    ...
    if (0 === o.length) {
      ...
      e = this.Dd.ss(c);
      f = {};
      for (g = 0; g < this.Aw.length; g++) i = this.Aw[g], i = a + "_" + i[0] + "_" + i[1] + "_" + e + "_" + c, this.dh[i] && (f[i] = this.dh[i], this.yF && this.Nv.uC.tC(this.dh[i].D0, this.dh[i].V_, this.dh[i].Zl, this.dh[i].Im, this.dh[i].lE, this.Dd.Id(this.dh[i].lE), this.Dd.rD(this.dh[i].lE), this.cb.JD));
      this.dh = f
    } else {
      this.Vs = o.length;
      this.sx = t;
      c = this.Dd.ss(this.P.ja());
      for (e = 0; e < a.length; e++) a[e][3] = c;
      for (e = 0; e < o.length; e++) a = o[e][2], f = o[e][0], g = o[e][1], o[e][3] = c, a.xn = t, a.WG = t, ie(this, f, g, c, a)
    }
  };

  function ie(a, b, c, e, f) {
    var g = b + "_" + c + "_" + e, i = a.xS;
    if (i[g]) {
      if ("loading" === i[g].status) return
    } else i[g] = {status: "init", sN: 0};
    var k = a, m = k.P, n = [], n = "0" === D.Zt ? k.cb.eO.http : k.cb.eO.https, o = Math.abs(b + c) % n.length,
      s = "x=" + b + "&y=" + c + "&z=" + e, v = je(a.Nv), w = v.BF, v = v.xF,
      y = "_" + (0 > b ? "_" : "") + (0 > c ? "$" : "") + parseInt(Math.abs(b) + "" + Math.abs(c) + "" + e, 10).toString(36),
      s = s + a.mB + "v=" + w + "&udt=" + v + "&fn=window." + y, w = n[o] + "&" + s,
    ...
    window[y] = function (a) {
      ...
      if (a) {
        ...
        if (o !== t) {
          ...
          o.IndoorCanvas = [];
          o.IndoorCanvas.push({canvasDom: f, data: a, canvasID: f.id, ratio: k.Hc});
          m.dispatchEvent(o);
          if (m.M.ok) {
            if (k.dh[f.id] = {
              D0: a,
              ...
              Im: c,
              lE: n
            }, k.Nv.uC.tC(a, f, b, c, n, k.Dd.Id(n), k.Dd.rD(n), k.cb.JD), k.cb.dF) {
              n = [];
              n.W_ = [b, c, e];
              if (a[0]) for (o = 0; o < a[0].length; o++) a[0][o][0] === Vd && n.push({aM: a[0][o]});
              if (a[2]) for (o = 0; o < a[2].length; o++) n.push({IY: a[2][o]});
              f.oF = n;
              k.Qr.push(n);
              k.sx === t && k.Vs--;
              (0 === k.Vs || k.sx === p) && he(k)
            }
          } else k.Vs--, (0 === k.Vs || k.sx === p) && he(k);
          delete window[y]
        }
      }
    };
  ...
  function he(a) {
    if (a.wx) {
      ...
      if (b.M.ok) {
        a.Xl();
        var c = a.Dd, e = b.ja(), f = c.ss(b.ja());
        a.Nv.uC.sK(a.Qr, a.cb.JD, a.ap, c.Id(e), Math.pow(2, e - f), e);
  ...
  ea.Xl = function () {
    var a = this.P.xb(), b = this.Hc;
    this.ap.clearRect(0, 0, a.width * b, a.height * b)
  };
  ea.remove = function () {
    var a = this.P.$e;
    this.bo && a.gg.removeChild(this.bo)
  };
  ...
  ea.ya = function () {
    ...
    setTimeout(function () {
      ...
      b.addEventListener("onmaptypechange", function (b) {
        b.Sa === Na && a.update({Xl: p, fm: "maptypechange"})
      })
    }, 1);
  ...
  ea.qL = function (a) {
    ...
    var c = this.P, e = c.ja(), f = c.Tb, g = a.rD(e);
    ...
    this.xr[b] = this.Ce.slice(0);
    return this.xr[b]
  };

  function je(a) {
    if (a.CF) return a.CF;
    a.CF = {BF: "001", xF: Tb("normal")};
    return a.CF
  }
  ...
  ea.update = function (a) {
    ...
    for (var b = 0; b < this.df.length; b++) {
      var c = this.df[b], e = this.qL(c.Dd);
      c.update(e, a)
    }
  };
  ...
  function ke(a, b, c) {
    ...
    1 <= this.df.length && (this.df[0].ew = p);
    A.extend(this.m, c)
  }

  A.extend(ke.prototype, {
    getName: x("hd"), Es: function () {
      return this.m.$_
    }, v3: function () {
      return this.m.fE
    }, KX: function () {
  ...
  var le = [D.url.proto + D.url.domain.TILE_BASE_URLS[0] + "/it/", D.url.proto + D.url.domain.TILE_BASE_URLS[1] + "/it/", D.url.proto + D.url.domain.TILE_BASE_URLS[2] + "/it/", D.url.proto + D.url.domain.TILE_BASE_URLS[3] + "/it/", D.url.proto + D.url.domain.TILE_BASE_URLS[4] + "/it/"],
    ...
    oe = {dark: "dl", light: "ll", normal: "pl"}, pe = new ud;
  pe.z_ = p;
  pe.getTilesUrl = function (a, b, c) {
    var e = a.x, a = a.y, f = Tb("normal"), g = 1, c = oe[c];
    this.map.lx() && (g = 2);
  ...
  var Na = new ke("\u5730\u56fe", pe, {tips: "\u663e\u793a\u666e\u901a\u5730\u56fe", maxZoom: 19}), qe = new ud;
  ...
  qe.getTilesUrl = function (a, b) {
    ...
    return url = this.dO[Math.abs(c + e) % this.dO.length] + this.map.Lb + "/" + this.map.mw + "/3/lv" + (21 - b) + "/" + c + "," + e + ".jpg"
  };
  var Qa = new ke("\u4e09\u7ef4", qe, {
    tips: "\u663e\u793a\u4e09\u7ef4\u5730\u56fe",
    minZoom: 15,
  ...
  Qa.sk = function (a) {
    if (!a) return "";
    var b = H.MB, c;
    for (c in b) if (-1 < a.search(c)) return b[c].Rx;
    return ""
  };
  Qa.TK = function (a) {
  ...
  var ab = new ke("\u536b\u661f", re, {
    ...
    maxZoom: 19,
    textColor: "white"
  }), se = new ud({transparentPng: p});
  se.getTilesUrl = function (a, b) {
    var c = a.x, e = a.y, f = Tb("satelliteStreet");
  ...
  var ve = {
    hG: D.nd, pb: function (a, b, c, e, f) {
      ...
      this.hG = c && c.CK ? c.qN ? c.qN : D.ep : D.nd;
  ...
  var we = 2, xe = 6, ye = 8, ze = 2, Ae = 3, Be = 6, Ce = 0, De = "bt", He = "nav", Ie = "walk", Je = "bl", Ke = "bsl",
    Le = "ride", Me = 15, Ne = 18;
  ...
  function Oe(a, b, c) {
    ...
    if (a) {
      ...
      this.LJ = b;
      this.update = p;
      a = {page: 1, R5: 100, Jd: 100, Xf: 4, AJ: "pg", update: p};
      c || (c = a);
  ...
  A.extend(Oe.prototype, {
    za: function () {
      ...
      if (this.page < this.Xf) e = 0 == this.page % this.Xf ? this.page - this.Xf - 1 : this.page - this.page % this.Xf + 1, b = e + this.Xf - 1; else {
        e = Math.floor(this.Xf / 2);
        var f = this.Xf % 2 - 1, b = this.Jd > this.page + e ? this.page + e : this.Jd;
        e = this.page - e - f
      }
      this.page > this.Jd - this.Xf && this.page >= this.Xf && (e = this.Jd - this.Xf + 1, b = this.Jd);
      for (f = e; f <= b; f++) 0 < f && (f == this.page ? a.push('<span style="margin-right:3px">' + f + "</span>") : 1 <= f && f <= this.Jd && (e = '<span><a style="color:#7777cc;margin-right:3px" href="javascript:void(0)" onclick="{temp3}">[' + f + "]</a></span>", a.push(e.replace("{temp3}", "BMap.I('" + this.da + "').toPage(" + f + ");"))));
      c > this.Jd || a.push('<span><a style="color:#7777cc" href="javascript:void(0)" onclick="{temp4}">\u4e0b\u4e00\u9875</a></span>'.replace("{temp4}", "BMap.I('" + this.da + "').toPage(" + c + ");"));
      a.push("</p>");
      return a.join("")
    }, toPage: function (a) {
      a = a ? a : 1;
  ...
  function fb(a, b) {
    ...
    this.wp(b.pageCapacity);
    "undefined" != typeof b.renderOptions.selectFirstResult && !b.renderOptions.selectFirstResult ? this.mC() : this.GC();
    this.Ba = [];
    this.wf = [];
    this.gb = -1;
    this.Ta = [];
  ...
  A.extend(fb.prototype, {
    search: function (a, b) {
      this.Ta.push({method: "search", arguments: [a, b]})
    }, Jm: function (a, b, c) {
      this.Ta.push({method: "searchInBounds", arguments: [a, b, c]})
    }, sp: function (a, b, c, e) {
  ...
  A.extend(Re.prototype, {
    Dt: function (a) {
      ...
      this.Ta.push({method: "_internalSearch", arguments: [a, b]})
    }, search: function (a, b) {
      this.Ta.push({method: "search", arguments: [a, b]})
    }, wp: function (a) {
    ...
    }, toString: da("TransitRoute"), Q1: function (a) {
      return a.replace(/\(.*\)/, "")
    }
  });
  var Se = Re.prototype;
  V(Se, {_internalSearch: Se.dA});
  ...
  A.extend(Te.prototype, {
    search: function (a, b, c) {
      this.Ta.push({method: "search", arguments: [a, b, c]})
    }
  });
  ...
  function Xe(a, b) {
    ...
    this.Hb = [{B: "", Ed: 0, Tm: 0, x: 0, y: 0, ra: -1}, {B: "", Ed: 0, Tm: 0, x: 0, y: 0, ra: -1}, {
      ...
      y: 0,
      ra: -1
    }, {B: "", Ed: 0, Tm: 0, x: 0, y: 0, ra: -1}, {B: "", Ed: 0, Tm: 0, x: 0, y: 0, ra: -1}, {
      B: "",
      Ed: 0,
      Tm: 0,
      x: 0,
  ...
  A.extend(af.prototype, {
    lm: function (a, b, c) {
      this.Ta.push({method: "getPoint", arguments: [a, b, c]})
    }, jm: function (a, b, c) {
      this.Ta.push({method: "getLocation", arguments: [a, b, c]})
    }, toString: da("Geocoder")
  });
  var bf = af.prototype;
  V(bf, {getPoint: bf.lm, getLocation: bf.jm});
  ...
  A.extend(cf.prototype, {
    get: function (a) {
      this.Ta.push({method: "get", arguments: [a]})
  ...
  A.extend(df.prototype, {
    get: function (a, b) {
      this.Ta.push({method: "get", arguments: [a, b]})
  ...
  ef.Zu = H.sa + "iw_plus.gif";
  ef.gS = H.sa + "iw_minus.gif";
  ef.ZT = H.sa + "stop_icon.png";
  A.xa(ef, X);
  A.extend(ef.prototype, {
    getBusList: function (a) {
      this.Ta.push({method: "getBusList", arguments: [a]})
    }, getBusLine: function (a) {
      this.Ta.push({method: "getBusLine", arguments: [a]})
  ...
  function ff(a) {
    X.call(this, a);
    a = a || {};
    this.cb = {input: a.input || q, FB: a.baseDom || q, types: a.types || [], gt: a.onSearchComplete || u()};
  ...
  A.extend(ff.prototype, {
    Mi: u(), show: u(), $: u(), aF: function (a) {
      this.cb.types = a
    }, Mm: function (a) {
      this.Ad.src = a
    }, search: ba("Wi"), dy: ba("HH"), Et: function (a) {
      this.cb.gt = a
    }
  });
  var Ua;
  ...
  function Pa(a, b) {
    function c() {
      f.m.visible ? ("inter" === f.Je && Wa() && f.m.haveBreakId && f.m.indoorExitControl === p ? A.U.show(f.Hq) : A.U.$(f.Hq), this.m.closeControl && this.Af && this.P && this.P.Ra() === this.R ? A.U.show(f.Af) : A.U.$(f.Af), this.m.forceCloseControl && A.U.show(f.Af)) : (A.U.$(f.Af), A.U.$(f.Hq))
    }
    ...
    this.m.rS !== p && (this.In(), D.$p("cus.fire", "count", "z_loadpanoramacount"));
    this.jT(this.R);
  ...
  A.extend(Pa.prototype, {
    ...
    rd: function (a) {
      if (a) {
        var a = this.Ka.pitch, b = this.Ka.heading, b = this.eC(b);
    ...
    $A: function () {
      if (this.P) for (var a = this.P.Yw(), b = 0; b < a.length; b++) (a[b] instanceof W || a[b] instanceof cd) && a[b].point && this.Ba.push(a[b])
    },
    XE: ba("P"),
    Ct: function (a) {
      this.Mf = a || "none"
    ...
    ix: function () {
      this.wj({copyrightControlOptions: {logoVisible: t}})
    },
    eF: function () {
      this.wj({copyrightControlOptions: {logoVisible: p}})
    },
    xB: function (a) {
      function b(a, b) {
        return function () {
          a.Xq.push({yM: b, xM: arguments})
        }
      }
  ...
  function mf() {
    A.lang.Ha.call(this);
    this.jd = "PanoramaOverlay_" + this.da;
    this.W = q;
    this.Ua = p
  }
  ...
  A.extend(nf.prototype, {
    ...
    Lo: x("aq"),
    Ja: function () {
      var a = this.la(), b = q, c = q;
      this.W && (c = this.W.la());
      if (a && c) if (a.Sb(c)) b = this.W.Ja(); else {
        b = {};
        b.heading = of(a.lng - c.lng, a.lat - c.lat) || 0;
        var a = b, c = this.Lo(), e = this.Cn();
  ...
  A.extend(qf.prototype, {
    va: function (a) {
      this.Jb = a;
      this.Lf("position", a)
    }, la: x("Jb"), Dc: function (a) {
      this.XI = a;
      this.Lf("title", a)
    }, So: x("XI"), Ub: function (a) {
      this.EH = icon;
      this.Lf("icon", a)
    }, No: x("EH"), QE: function (a) {
      this.aq = a;
      this.Lf("altitude", a)
    }, Lo: x("aq"), uD: x("WS"), Ja: function () {
      var a = q;
      if (this.W) {
        var a = this.W.la(), b = this.la(), a = of(b.lng - a.lng, b.lat - a.lat);
        isNaN(a) && (a = 0);
        a = {heading: a, pitch: 0}
      } else a = this.Ka;
      return a
  ...
  D.Gk(function (a) {
    "flashRender" !== a.Eq() && new Mc(a, {Se: "api"})
  });
  A.extend(Mc.prototype, {
    ga: function () {
      function a(a) {
        if (a) {
          if (a.id != b.Hv) {
            ...
            a.Vl ? (b.wj({haveBreakId: p}), Wa() && b.m.closeControl && A.U.show(b.Hq)) : A.U.$(b.Hq)
          }
        } else b.fb = b.ql, b.Jb = b.rl, b.dispatchEvent(new P("onnoresult"))
      }
      ...
      b.addEventListener("iid_changed", function () {
        c.Vg(Mc.al + "qt=idata&iid=" + b.Uz + "&fn=", function (b) {
  ...
  var vf = Mc.prototype;
  V(vf, {getPanoramaById: vf.Qo, getPanoramaByLocation: vf.ij, getPanoramaByPOIId: vf.Zw});
  ...
  var xf = wf;
  V(xf, {dispatchFlashEvent: xf.WV});
  var yf = {dP: 50};
  yf.nu = D.di("pano")[0];
  yf.lu = {width: 220, height: 60};
  A.extend(yf, {
    ML: function (a, b, c, e) {
      if (!b || !c || !c.lngLat || !c.panoInstance) e(); else {
        this.On === l && (this.On = new Mc(q, {Se: "api"}));
        var f = this;
        this.On.KB(b, function (b) {
          b ? f.On.ij(c.lngLat, yf.dP, function (b) {
            if (b && b.id) {
              var g = b.id, m = b.ph, b = b.qh, n = Mc.Vd.zg(c.lngLat), o = f.JR(n, {x: m, y: b}),
                m = f.eL(g, o, 0, yf.lu.width, yf.lu.height);
              a.content = f.KR(a.content, m, c.titleTip, c.beforeDomId);
              a.addEventListener("open", function () {
                ia.V(A.Ec("infoWndPano"), "click", function () {
                  c.panoInstance.Cc(g);
                  c.panoInstance.show();
                  c.panoInstance.rd({heading: o, pitch: 0})
                })
              })
            }
            e()
      ...
      f = [];
      var g = yf.lu.width, i = yf.lu.height;
      f.push(e);
      ...
      return (yf.nu + "?qt=pr3d&fovy=75&quality=80&panoid={panoId}&heading={panoHeading}&pitch={panoPitch}&width={width}&height={height}").replace(/\{(.*?)\}/g, function (a, b) {
        return g[b]
      })
    }
  });
  ...
  var Hf = Cf ? "-" + Cf.toLowerCase() + "-" : "", Jf = If("transform"), Kf = If("transitionProperty"),
    Lf = If("transitionDuration"), Mf = If("transformOrigin"), Nf = If("transitionTimingFunction"),
    Of = If("transitionDelay"), Ze = /android/gi.test(navigator.appVersion),
    Pf = /iphone|ipad/gi.test(navigator.appVersion), Qf = /hp-tablet/gi.test(navigator.appVersion),
    Rf = If("perspective") in Bf, Sf = "ontouchstart" in window && !Qf, Tf = Cf !== t, Uf = If("transition") in Bf,
    Vf = "onorientationchange" in window ? "orientationchange" : "resize", Wf = Sf ? "touchstart" : "mousedown",
    Xf = Sf ? "touchmove" : "mousemove", Yf = Sf ? "touchend" : "mouseup", Zf = Sf ? "touchcancel" : "mouseup",
    $f = Cf === t ? t : {
      "": "transitionend",
  ...
  function eg(a, b) {
    var c = this, e;
    c.Xm = "object" == typeof a ? a : zf.getElementById(a);
    c.Xm.style.overflow = "hidden";
    c.Pb = c.Xm.children[0];
    c.options = {
      Wo: p,
      Um: p,
      x: 0,
    ...
    c.options.ei = c.options.Wo && c.options.ei;
    c.options.xi = c.options.Um && c.options.xi;
    ...
    c.ga(Vf, window);
    c.ga(Wf);
    !Sf && "none" != c.options.JO && (c.ga("DOMMouseScroll"), c.ga("mousewheel"));
    c.options.kw && (c.dV = setInterval(function () {
      c.eQ()
    }, 500));
  ...
  eg.prototype = {
    ...
    oQ: function (a) {
      ...
      if ("select" != b && "input" != b && "textarea" != b) return a.stopImmediatePropagation ? a.stopImmediatePropagation() : a.GZ = p, a.stopPropagation(), a.preventDefault(), this.Kw = this.tB = q, t
    },
    Av: function (a) {
      ...
      if (this.enabled) {
        ...
        this.jC = this.iC = this.Tv = this.Sv = this.pC = this.oC = 0;
        this.options.zoom && (Sf && 1 < a.touches.length) && (e = Af.abs(a.touches[0].pageX - a.touches[1].pageX), c = Af.abs(a.touches[0].pageY - a.touches[1].pageY), this.e0 = Af.sqrt(e * e + c * c), this.Lx = Af.abs(a.touches[0].pageX + a.touches[1].pageX - 2 * this.FF) / 2 - this.x, this.Mx = Af.abs(a.touches[0].pageY + a.touches[1].pageY - 2 * this.GF) / 2 - this.y, this.options.ip && this.options.ip.call(this, a));
        if (this.options.Dx && (this.options.Uk ? (c = getComputedStyle(this.Pb, q)[Jf].replace(/[^0-9\-.,]/g, "").split(","), e = +(c[12] || c[4]), c = +(c[13] || c[5])) : (e = +getComputedStyle(this.Pb, q).left.replace(/[^0-9-]/g, ""), c = +getComputedStyle(this.Pb, q).top.replace(/[^0-9-]/g, "")), e != this.x || c != this.y)) this.options.wi ? this.Zd($f) : cg(this.EB), this.xj = [], this.$q(e, c), this.options.Jx && this.options.Jx.call(this);
        this.Uv = this.x;
        this.Vv = this.y;
        this.Pt = this.x;
        this.Qt = this.y;
    ...
    GS: function (a) {
      var b = Sf ? a.touches[0] : a, c = b.pageX - this.ph, e = b.pageY - this.qh, f = this.x + c, g = this.y + e,
        i = a.timeStamp || Date.now();
      this.options.HM && this.options.HM.call(this, a);
      if (this.options.zoom && Sf && 1 < a.touches.length) f = Af.abs(a.touches[0].pageX - a.touches[1].pageX), g = Af.abs(a.touches[0].pageY - a.touches[1].pageY), this.d0 = Af.sqrt(f * f + g * g), this.Xk = p, b = 1 / this.e0 * this.d0 * this.scale, b < this.options.Wk ? b = 0.5 * this.options.Wk * Math.pow(2, b / this.options.Wk) : b > this.options.Kp && (b = 2 * this.options.Kp * Math.pow(0.5, this.options.Kp / b)), this.bp = b / this.scale, f = this.Lx - this.Lx * this.bp + this.x, g = this.Mx - this.Mx * this.bp + this.y, this.Pb.style[Jf] = "translate(" + f + "px," + g + "px) scale(" + b + ")" + dg, this.options.VM && this.options.VM.call(this, a); else {
        this.ph = b.pageX;
        this.qh = b.pageY;
        if (0 < f || f < this.he) f = this.options.ro ? this.x + c / 2 : 0 <= f || 0 <= this.he ? 0 : this.he;
        if (g > this.pf || g < this.qd) g = this.options.ro ? this.y + e / 2 : g >= this.pf || 0 <= this.qd ? this.pf : this.qd;
        this.oC += c;
        this.pC += e;
        this.Sv = Af.abs(this.oC);
        this.Tv = Af.abs(this.pC);
        6 > this.Sv && 6 > this.Tv || (this.options.jE && (this.Sv > this.Tv + 5 ? (g = this.y, e = 0) : this.Tv > this.Sv + 5 && (f = this.x, c = 0)), this.oh = p, this.$q(f, g), this.iC = 0 < c ? -1 : 0 > c ? 1 : 0, this.jC = 0 < e ? -1 : 0 > e ? 1 : 0, 300 < i - this.startTime && (this.startTime = i, this.Pt = this.x, this.Qt = this.y), this.options.SM && this.options.SM.call(this, a))
      }
    },
    Ku: function (a) {
      if (!(Sf && 0 !== a.touches.length)) {
        var b = this, c = Sf ? a.changedTouches[0] : a, e, f, g = {Ga: 0, time: 0}, i = {Ga: 0, time: 0},
        ...
        if (b.Xk) e = b.scale * b.bp, e = Math.max(b.options.Wk, e), e = Math.min(b.options.Kp, e), b.bp = e / b.scale, b.scale = e, b.x = b.Lx - b.Lx * b.bp + b.x, b.y = b.Mx - b.Mx * b.bp + b.y, b.Pb.style[Lf] = "200ms", b.Pb.style[Jf] = "translate(" + b.x + "px," + b.y + "px) scale(" + b.scale + ")" + dg, b.Xk = t, b.refresh(), b.options.hp && b.options.hp.call(b, a); else {
          if (b.oh) {
            if (300 > k && b.options.Dx) {
              g = e ? b.UH(e - b.Pt, k, -b.x, b.by - b.cu + b.x, b.options.ro ? b.cu : 0) : g;
              i = f ? b.UH(f - b.Qt, k, -b.y, 0 > b.qd ? b.rp - b.Ym + b.y - b.pf : 0, b.options.ro ? b.Ym : 0) : i;
              e = b.x + g.Ga;
              f = b.y + i.Ga;
              if (0 < b.x && 0 < e || b.x < b.he && e < b.he) g = {Ga: 0, time: 0};
              if (b.y > b.pf && f > b.pf || b.y < b.qd && f < b.qd) i = {Ga: 0, time: 0}
            }
            ...
            if (Sf) if (b.lK && b.options.zoom) clearTimeout(b.lK), b.lK = q, b.options.ip && b.options.ip.call(b, a), b.zoom(b.ph, b.qh, 1 == b.scale ? b.options.YV : 1), b.options.hp && setTimeout(function () {
              b.options.hp.call(b, a)
    ...
    Rn: function (a) {
      ...
      if (b == this.x && c == this.y) {
        if (this.oh && (this.oh = t, this.options.Jx && this.options.Jx.call(this)), this.ei && this.options.jx && ("webkit" == Cf && (this.zL.style[Of] = "300ms"), this.zL.style.opacity = "0"), this.xi && this.options.jx) "webkit" == Cf && (this.CO.style[Of] = "300ms"), this.CO.style.opacity = "0"
    ...
    kU: function (a) {
      ...
      if ("zoom" == b.options.JO) {
        if (e = b.scale * Math.pow(2, 1 / 3 * (e ? e / Math.abs(e) : 0)), e < b.options.Wk && (e = b.options.Wk), e > b.options.Kp && (e = b.options.Kp), e != b.scale) !b.zy && b.options.ip && b.options.ip.call(b, a), b.zy++, b.zoom(a.pageX, a.pageY, e, 400), setTimeout(function () {
          b.zy--;
          !b.zy && b.options.hp && b.options.hp.call(b, a)
        }, 400)
      } else c = b.x + c, e = b.y + e, 0 < c ? c = 0 : c < b.he && (c = b.he), e > b.pf ? e = b.pf : e < b.qd && (e = b.qd), 0 > b.qd && b.scrollTo(c, e, 0)
    },
    hU: function (a) {
      a.target == this.Pb && (this.Zd($f), this.fB())
    },
    fB: function () {
      var a = this, b = a.x, c = a.y, e = Date.now(), f, g, i;
      a.Sl || (a.xj.length ? (f = a.xj.shift(), f.x == b && f.y == c && (f.time = 0), a.Sl = p, a.oh = p, a.options.wi) ? (a.ZI(f.time), a.$q(f.x, f.y), a.Sl = t, f.time ? a.ga($f) : a.Rn(0)) : (i = function () {
        var k = Date.now(), m;
        if (k >= e + f.time) {
          a.$q(f.x, f.y);
          a.Sl = t;
    ...
    UH: function (a, b, c, e, f) {
      var b = Af.abs(a) / b, g = b * b / 0.0012;
      0 < a && g > c ? (c += f / (6 / (6.0E-4 * (g / b))), b = b * c / g, g = c) : 0 > a && g > e && (e += f / (6 / (6.0E-4 * (g / b))), b = b * e / g, g = e);
      return {Ga: g * (0 > a ? -1 : 1), time: Af.round(b / 6.0E-4)}
    },
    Wj: function (a) {
      for (var b = -a.offsetLeft, c = -a.offsetTop; a = a.offsetParent;) b -= a.offsetLeft, c -= a.offsetTop;
      a != this.Xm && (b *= this.scale, c *= this.scale);
      return {left: b, top: c}
    },
    OI: function (a, b) {
      var c, e, f;
      ...
      f == this.$B && (0 < f && 0 > this.iC) && f--;
      a = this.Xe[f];
      e = (e = Af.abs(a - this.Xe[this.$B])) ? 500 * (Af.abs(this.x - a) / e) : 0;
      this.$B = f;
      f = this.rf.length - 1;
      ...
      b = this.rf[f];
      c = (c = Af.abs(b - this.rf[this.aC])) ? 500 * (Af.abs(this.y - b) / c) : 0;
      this.aC = f;
    ...
    refresh: function () {
      ...
      this.cu = this.Xm.clientWidth || 1;
      this.Ym = this.Xm.clientHeight || 1;
      this.pf = -this.options.c0 || 0;
      this.by = Af.round(this.Pb.offsetWidth * this.scale);
      this.rp = Af.round((this.Pb.offsetHeight + this.pf) * this.scale);
      this.he = this.cu - this.by;
      this.qd = this.Ym - this.rp + this.pf;
      this.jC = this.iC = 0;
      this.options.QM && this.options.QM.call(this);
      this.Wo = this.options.Wo && 0 > this.he;
      this.Um = this.options.Um && (!this.options.RU && !this.Wo || this.rp > this.Ym);
      this.ei = this.Wo && this.options.ei;
      this.xi = this.Um && this.options.xi && this.rp > this.Ym;
      a = this.Wj(this.Xm);
      this.FF = -a.left;
      this.GF = -a.top;
      if ("string" == typeof this.options.Lt) {
        this.Xe = [];
        this.rf = [];
        c = this.Pb.querySelectorAll(this.options.Lt);
        a = 0;
        for (b = c.length; a < b; a++) e = this.Wj(c[a]), e.left += this.FF, e.top += this.GF, this.Xe[a] = e.left < this.he ? this.he : e.left * this.scale, this.rf[a] = e.top < this.qd ? this.qd : e.top * this.scale
      } else if (this.options.Lt) {
        for (this.Xe = []; e >= this.he;) this.Xe[b] = e, e -= this.cu, b++;
        this.he % this.cu && (this.Xe[this.Xe.length] = this.he - this.Xe[this.Xe.length - 1] + this.Xe[this.Xe.length - 1]);
        b = e = 0;
        for (this.rf = []; e >= this.qd;) this.rf[b] = e, e -= this.Ym, b++;
        this.qd % this.Ym && (this.rf[this.rf.length] = this.qd - this.rf[this.rf.length - 1] + this.rf[this.rf.length - 1])
      }
      this.rv("h");
      this.rv("v");
      this.Xk || (this.Pb.style[Lf] = "0", this.Rn(400))
    },
    scrollTo: function (a, b, c, e) {
      var f = a;
      this.stop();
      f.length || (f = [{x: a, y: b, time: c, IZ: e}]);
      a = 0;
      for (b = f.length; a < b; a++) f[a].IZ && (f[a].x = this.x - f[a].x, f[a].y = this.y - f[a].y), this.xj.push({
        x: f[a].x,
        y: f[a].y,
        time: f[a].time || 0
      });
    ...
    stop: function () {
      this.options.wi ? this.Zd($f) : cg(this.EB);
      this.xj = [];
      this.Sl = this.oh = t
    },
  ...
  function fg(a) {
    this.m = {anchor: Fc, offset: new N(0, 0), maxWidth: "100%", imageHeight: 80};
    var a = a || {}, b;
    for (b in a) this.m[b] = a[b];
    this.Hl = new Mc(q, {Se: "api"});
    this.Yj = [];
    this.W = q;
    this.fg = {height: this.m.imageHeight, width: this.m.imageHeight * gg};
  ...
  D.Gk(function (a) {
    ...
    a.addEventListener("position_changed", function () {
      a.m.visible && a.m.albumsControl === p && (b ? b.Xx(a.Wb()) : (b = new fg(a.m.albumsControlOptions), b.ya(a)))
    });
    a.addEventListener("albums_visible_changed", function () {
      a.m.albumsControl === p ? (b ? b.Xx(a.Wb()) : (b = new fg(a.m.albumsControlOptions), b.ya(a)), b.show()) : b.$()
    });
  ...
  A.extend(fg.prototype, {
    wj: function (a) {
      ...
      this.ck = L("div", {"class": "pano_photo_item_seleted"});
      this.ck.style.height = this.fg.height - 6 + "px";
      this.ck.style.width = this.fg.width - 6 + "px";
      this.rc(this.m.anchor)
    }, oH: function (a) {
      for (var b = this.Yj, c = b.length - 1; 0 <= c; c--) if (b[c].panoId == a) return c;
      return -1
    }, Xx: function (a, b) {
      if (b || !this.Yj[this.Xc] || !(this.Yj[this.Xc].panoId == a && 3 !== this.Yj[this.Xc].recoType)) {
        var c = this, e = this.oH(a);
        !b && -1 !== e && this.Yj[e] && 3 !== this.Yj[e].recoType ? this.vp(e) : this.BX(function (a) {
          for (var b = {}, e, k, m = t, n = [], o = 0, s = a.length; o < s; o++) e = a[o].catlog, k = a[o].floor, l !== e && ("" === e && l !== k ? (m = p, b[k] || (b[k] = []), b[k].push(a[o])) : (b[hg[e]] || (b[hg[e]] = []), b[hg[e]].push(a[o])));
          for (var v in b) m ? n.push({data: v + "F", index: v}) : n.push({data: ig[v], index: v});
          c.HG = b;
          c.Ki = n;
          c.El(a);
          0 == a.length ? c.$() : c.show()
      ...
      if (!this.Hi) {
        ...
        new eg(a, {ro: t, Dx: p, ei: t, xi: t, Um: t, jE: p, kw: p, fx: p});
      ...
      if (this.Hi) a = this.SK(this.Ki), this.cQ.innerHTML = a; else {
        var a = this.SK(this.Ki), b = L("ul"), c = this;
        ...
        var a = L("div"), e = L("a"), f = L("span"), g = L("a"), i = L("span"),
        ...
        A.V(e, "mouseover", function () {
          ...
          new wb({
            Ic: 60, ac: xb.fs, duration: 300, za: function (c) {
      ...
      this.Yj = a;
      this.m.showCatalog && (0 < this.Ki.length ? (Wa() ? this.BV() : this.EV(), this.Rc.offsetLeft = 60) : (this.is && (this.R.removeChild(this.is), this.is = q, this.Rc.hg.style.left = "0px"), this.Hi && (this.R.removeChild(this.Hi), this.Hi = q), this.Rc.offsetLeft = 0));
      var b = this.iX(a);
      Wa() && (this.Ki && 0 < this.Ki.length && this.m.showExit && this.yz) && (this.Rc.offsetLeft += this.fg.width + 8, this.is ? this.is.innerHTML = this.yz : this.CV());
      this.Oh.innerHTML = b;
      this.Oh.style.width = (this.fg.width + 8) * a.length + 8 + "px";
      a = this.R.offsetWidth;
      b = this.Oh.offsetWidth;
      this.Rc.rs && (b += this.Rc.rs());
      ...
      var b = this, c = this.W.Wb();
      c && this.Hl.ax(c, function (e) {
        b.W.Wb() === c && a(e)
      })
    }, rc: function (a) {
      ...
      A.V(this.dk, "click", function (b) {
        if ((b = (b.srcElement || b.target).getAttribute("data-index")) && b != a.Xc) a.vp(b), a.W.Cc(a.Yj[b].panoId)
      });
      ...
      this.W.addEventListener("size_changed", function () {
        isNaN(Number(a.m.maxWidth)) && a.wj({maxWidth: a.m.maxWidth})
      })
    }, vp: function (a) {
      this.ck.style.left = this.VA[a].offsetLeft + 8 + "px";
      this.ck.setAttribute("data-index", this.VA[a].getAttribute("data-index"));
      this.Xc = a;
      this.VJ(a)
    }, VJ: function (a, b) {
      var c = this.fg.width + 8, e = 0;
      this.Rc.rs && (e = this.Rc.rs() / 2);
      var f = this.dk.offsetWidth - 2 * e, g = this.Oh.offsetLeft || this.Rc.x, g = g - e, i = -a * c;
      i > g && this.Rc.scrollTo(i + e);
      c = i - c;
      g -= f;
      c < g && (!b || b && 8 < i - g) && this.Rc.scrollTo(c + f + e)
    }, mY: function () {
      this.Rc = I() ? new eg(this.dk, {ro: t, Dx: p, ei: t, xi: t, Um: t, jE: p, kw: p, fx: p}) : new jg(this.dk)
    }, $: function () {
  ...
  jg.prototype = {
    ya: function () {
      ...
      this.Mn = this.R.offsetWidth - this.rs();
      this.sA = -(this.Xg.offsetWidth - this.Mn - this.Ai);
      this.cv = this.Ai + this.offsetLeft;
      this.Xg.style.left = this.cv + "px";
      this.Xg.children[0] && (this.qr = this.Xg.children[0].offsetWidth);
      this.hg && (this.hg.children[0].style.marginTop = this.ir.children[0].style.marginTop = this.hg.offsetHeight / 2 - this.hg.children[0].offsetHeight / 2 + "px")
    }, rs: function () {
      return 2 * this.Ai
    }, Nr: function () {
      this.sv = L("div");
      this.sv.innerHTML = '<a class="pano_photo_arrow_l" style="background:rgb(37,37,37);background:rgba(37,37,37,0.9);" href="javascript:void(0)" title="\u4e0a\u4e00\u9875"><span class="pano_arrow_l"></span></a><a class="pano_photo_arrow_r" style="background:rgb(37,37,37);background:rgba(37,37,37,0.9);" href="javascript:void(0)" title="\u4e0b\u4e00\u9875"><span class="pano_arrow_r"></span></a>';
      this.hg = this.sv.children[0];
      this.ir = this.sv.children[1];
      this.R.appendChild(this.sv);
      this.hg.children[0].style.marginTop = this.ir.children[0].style.marginTop = this.hg.offsetHeight / 2 - this.hg.children[0].offsetHeight / 2 + "px"
    }, GB: function () {
      var a = this;
      ...
      A.U.qc(this.ir, "pano_arrow_disable");
      var a = this.Xg.offsetLeft;
      a >= this.cv && A.U.hb(this.hg, "pano_arrow_disable");
      a - this.Mn <= this.sA && A.U.hb(this.ir, "pano_arrow_disable")
    }, scrollTo: function (a) {
      a = a < this.Xg.offsetLeft ? Math.ceil((a - this.Ai - this.Mn) / this.qr) * this.qr + this.Mn + this.Ai - 8 : Math.ceil((a - this.Ai) / this.qr) * this.qr + this.Ai;
      a < this.sA ? a = this.sA : a > this.cv && (a = this.cv);
      var b = this.Xg.offsetLeft, c = this;
      new wb({
        Ic: 60, ac: xb.fs, duration: 300, za: function (e) {
  ...
  V(window, {BMAP_NORMAL_MAP: Na, BMAP_PERSPECTIVE_MAP: Qa, BMAP_SATELLITE_MAP: ab, BMAP_HYBRID_MAP: Sa});
  var mg = T.prototype;
  V(mg, {lngLatToPoint: mg.zg, pointToLngLat: mg.vj});
  var ng = jb.prototype;
  V(ng, {lngLatToPoint: ng.zg, pointToLngLat: ng.vj});
  var og = hb.prototype;
  V(og, {
    equals: og.Sb,
    containsPoint: og.Lr,
  ...
  var pg = Uc.prototype;
  V(pg, {isVisible: pg.Oc, show: pg.show, hide: pg.$});
  Uc.getZIndex = Uc.zk;
  var qg = ib.prototype;
  V(qg, {
    openInfoWindow: qg.$c,
  ...
  var wg = pd.prototype;
  V(wg, {setCenter: wg.tf, getCenter: wg.Nb, getRadius: wg.gL, setRadius: wg.uf});
  var xg = nd.prototype;
  V(xg, {getPath: xg.Ue, setPath: xg.ke, setPositionAt: xg.Nm});
  var yg = kb.prototype;
  V(yg, {getPosition: yg.la, setPosition: yg.va, getText: yg.zD, setText: yg.Ft});
  ...
  var Ag = mb.prototype;
  V(Ag, {getType: Ag.Uo, setType: Ag.Om});
  V(window, {
  ...
  var Bg = ob.prototype;
  V(Bg, {changeView: Bg.qe, setSize: Bg.Be, getSize: Bg.xb});
  var Cg = nb.prototype;
  V(Cg, {getUnit: Cg.PX, setUnit: Cg.bF});
  V(window, {BMAP_UNIT_METRIC: "metric", BMAP_UNIT_IMPERIAL: "us"});
  var Dg = Hc.prototype;
  V(Dg, {addCopyright: Dg.Yv, removeCopyright: Dg.HE, getCopyright: Dg.hm, getCopyrightCollection: Dg.iD});
  V(window, {BMAP_MAPTYPE_CONTROL_HORIZONTAL: Jc, BMAP_MAPTYPE_CONTROL_DROPDOWN: 1, BMAP_MAPTYPE_CONTROL_MAP: 2});
  var Eg = ud.prototype;
  V(Eg, {getMapType: Eg.wa, getCopyright: Eg.hm, isTransparentPng: Eg.Us});
  var Fg = Nc.prototype;
  V(Fg, {addItem: Fg.Zv, addSeparator: Fg.yB, removeSeparator: Fg.JE});
  var Gg = Qc.prototype;
  V(Gg, {setText: Gg.Ft});
  var Hg = X.prototype;
  V(Hg, {
  ...
  var Jg = $e.prototype;
  V(Jg, {routeCall: Jg.xN});
  V(window, {BMAP_HIGHLIGHT_STEP: 1, BMAP_HIGHLIGHT_ROUTE: 2});
  V(window, {BMAP_ROUTE_TYPE_DRIVING: Ae, BMAP_ROUTE_TYPE_WALKING: ze, BMAP_ROUTE_TYPE_RIDING: Be});
  V(window, {BMAP_ROUTE_STATUS_NORMAL: Ce, BMAP_ROUTE_STATUS_EMPTY: 1, BMAP_ROUTE_STATUS_ADDRESS: 2});
  var Kg = Ue.prototype;
  V(Kg, {setPolicy: Kg.Dt});
  var Lg = ff.prototype;
  V(Lg, {show: Lg.show, hide: Lg.$, setTypes: Lg.aF, setLocation: Lg.Mm, search: Lg.search, setInputValue: Lg.dy});
  V(qb.prototype, {});
  var Mg = df.prototype;
  V(Mg, {get: Mg.get});
  V(Lc.prototype, {});
  V(window, {BMAP_POINT_DENSITY_HIGH: 200, BMAP_POINT_DENSITY_MEDIUM: Ed, BMAP_POINT_DENSITY_LOW: 50});
  V(window, {
  ...
  V(window, {BMAP_CONTEXT_MENU_ICON_ZOOMIN: Oc, BMAP_CONTEXT_MENU_ICON_ZOOMOUT: Pc});
  V(window, {
    BMAP_SYS_DRAWER: La,
    BMAP_SVG_DRAWER: 1,
    BMAP_VML_DRAWER: 2,
